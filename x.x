...
(set (get special "do") (table compiler compile-do terminated true))
(set (get special "if") (table compiler compile-if terminated true))
(set (get special "function")
     (table compiler compile-function terminated true))
(set (get special "macro") (table compiler compile-macro terminated true))
(set (get special "while") (table compiler compile-while terminated true))
(set (get special "local") (table compiler compile-local))
(set (get special "set") (table compiler compile-set))
...
(set (get special "each") (table compiler compile-each))
