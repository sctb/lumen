  ...
  for (_k7 in __o5) {
    ...
    if (! number63(_k8)) {
      ...
      if (quasisplice63(_v4, depth)) {
        _e28 = quasiexpand(_v4[1]);
      } else {
        _e28 = quasiexpand(_v4, depth);
      }
      var _v5 = _e28;
      last(_xs)[_k8] = _v5;
    }
...
indentation = function () {
  var _s = "";
  var _i9 = 0;
  while (_i9 < indent_level) {
    _s = _s + "  ";
    _i9 = _i9 + 1;
  }
  return(_s);
};
var reserved = {"<": true, ">": true, "catch": true, "%": true, "finally": true, "end": true, "else": true, "throw": true, "delete": true, "/": true, "in": true, "or": true, "var": true, "continue": true, "new": true, "for": true, "local": true, "not": true, "+": true, "instanceof": true, "-": true, "debugger": true, "break": true, "switch": true, "=": true, "do": true, "let": true, "elseif": true, "then": true, "if": true, "until": true, "nil": true, "repeat": true, "true": true, "class": true, "while": true, "const": true, "default": true, "<=": true, "try": true, "with": true, ">=": true, "and": true, "case": true, "typeof": true, "void": true, "import": true, "*": true, "return": true, "function": true, "false": true, "==": true};
...
__x80.lua = "or";
__x79["or"] = __x80;
var infix = [__x68, __x70, __x71, __x73, __x74, __x75, __x77, __x79];
...
var op_delims = function (parent, child) {
  ...
  if (_e36(precedence(_child), precedence(_parent))) {
    return(["(", ")"]);
  } else {
    return(["", ""]);
  }
...
var compile_infix = function (form) {
  ...
  var _ao = __id111[0];
  var _ac = __id111[1];
  var __id12 = op_delims(form, _b2, {_stash: true, right: true});
  var _bo = __id12[0];
  var _bc = __id12[1];
  var _a2 = compile(_a1);
  var _b3 = compile(_b2);
...
compile_function = function (args, body) {
  ...
  var __x89 = compile(_body3, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _body4 = __x89;
...
compile = function (form) {
  ...
  if (nil63(_form)) {
    ...
    if (special_form63(_form)) {
      ...
      var _e42;
      if (atom63(_form)) {
        _e42 = compile_atom(_form);
      } else {
        var _e43;
        if (infix63(hd(_form))) {
          _e43 = compile_infix(_form);
        } else {
          _e43 = compile_call(_form);
        }
        _e42 = _e43;
      }
      var _form1 = _e42;
...
var lower_do = function (args, hoist, stmt63, tail63) {
  var __x95 = almost(args);
  var __i17 = 0;
  while (__i17 < _35(__x95)) {
    var _x96 = __x95[__i17];
    var __y = lower(_x96, hoist, stmt63);
    if (yes(__y)) {
      var _e1 = __y;
      if (standalone63(_e1)) {
        add(hoist, _e1);
...
var lower_if = function (args, hoist, stmt63, tail63) {
  ...
  if (stmt63) {
    var _e48;
    if (is63(_else)) {
      _e48 = [lower_body([_else], tail63)];
    }
    return(add(hoist, join(["%if", lower(_cond, hoist), lower_body([_then], tail63)], _e48)));
  } else {
    var _e3 = unique("e");
    add(hoist, ["%local", _e3]);
    var _e47;
    if (is63(_else)) {
      _e47 = [lower(["%set", _e3, _else])];
    }
    add(hoist, join(["%if", lower(_cond, hoist), lower(["%set", _e3, _then])], _e47));
    return(_e3);
  }
};
var lower_short = function (x, args, hoist) {
  ...
  var _b4 = __id18[1];
  var _hoist1 = [];
  var _b11 = lower(_b4, _hoist1);
  if (some63(_hoist1)) {
    var _id19 = unique("id");
    var _e49;
    if (x === "and") {
      _e49 = ["%if", _id19, _b4, _id19];
    } else {
      _e49 = ["%if", _id19, _id19, _b4];
    }
    return(lower(["do", ["%local", _id19, _a3], _e49], hoist));
  } else {
...
var lower_while = function (args, hoist) {
  ...
  var _e50;
  if (none63(_pre)) {
    _e50 = ["while", _c5, lower_body(_body5)];
  } else {
    _e50 = ["while", true, join(["do"], _pre, [["%if", ["not", _c5], ["break"]], lower_body(_body5)])];
  }
  return(add(hoist, _e50));
};
                  ...
                  if (_x131 === "while") {
                    ...
                    if (_x131 === "%for") {
                      ...
                      if (_x131 === "%function") {
                        ...
                        if (_x131 === "%local-function" || _x131 === "%global-function") {
                          return(lower_definition(_x131, _args9, hoist));
                        } else {
                          if (in63(_x131, ["and", "or"])) {
                            return(lower_short(_x131, _args9, hoist));
                          } else {
                            if (statement63(_x131)) {
...
setenv("do", {_stash: true, special: function () {
  ...
  var __x137 = _forms1;
  var __i19 = 0;
  while (__i19 < _35(__x137)) {
    var _x138 = __x137[__i19];
    if (target === "lua" && immediate_call63(_x138) && "\n" === char(_s3, edge(_s3))) {
      _s3 = clip(_s3, 0, edge(_s3)) + ";\n";
    }
    _s3 = _s3 + compile(_x138, {_stash: true, stmt: true});
    if (! atom63(_x138)) {
      if (hd(_x138) === "return" || hd(_x138) === "break") {
        break;
      }
    }
    __i19 = __i19 + 1;
...
setenv("%if", {_stash: true, special: function (cond, cons, alt) {
  ...
  indent_level = indent_level + 1;
  var __x141 = compile(cons, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _cons1 = __x141;
  var _e51;
  if (alt) {
    indent_level = indent_level + 1;
    var __x142 = compile(alt, {_stash: true, stmt: true});
    indent_level = indent_level - 1;
    _e51 = __x142;
  }
  var _alt1 = _e51;
...
setenv("while", {_stash: true, special: function (cond, form) {
  ...
  indent_level = indent_level + 1;
  var __x144 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _body10 = __x144;
...
setenv("%for", {_stash: true, special: function (t, k, form) {
  ...
  indent_level = indent_level + 1;
  var __x146 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _body12 = __x146;
  if (target === "lua") {
...
setenv("%try", {_stash: true, special: function (form) {
  ...
  indent_level = indent_level + 1;
  var __x151 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _body14 = __x151;
  var _hf1 = ["return", ["%array", false, _e8]];
  indent_level = indent_level + 1;
  var __x154 = compile(_hf1, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var _h1 = __x154;
  return(_ind9 + "try {\n" + _body14 + _ind9 + "}\n" + _ind9 + "catch (" + _e8 + ") {\n" + _h1 + _ind9 + "}\n");
}, stmt: true, tr: true});
...
setenv("%global-function", {_stash: true, special: function (name, args, body) {
  if (target === "lua") {
    var _x158 = compile_function(args, body, {_stash: true, name: name});
...
setenv("%local-function", {_stash: true, special: function (name, args, body) {
  if (target === "lua") {
    var _x164 = compile_function(args, body, {_stash: true, name: name, prefix: "local"});
...
setenv("error", {_stash: true, special: function (x) {
  var _e53;
  if (target === "js") {
    _e53 = "throw " + compile(["new", ["Error", x]]);
  } else {
    _e53 = "error(" + compile(x) + ")";
  }
  var _e12 = _e53;
...
setenv("%object", {_stash: true, special: function () {
  ...
  for (_k19 in __o12) {
    ...
    if (number63(_k20)) {
      ...
      var _v13 = __id30[1];
      if (! string63(_k21)) {
        throw new Error("Illegal key: " + str(_k21));
      }
      _s9 = _s9 + _c9 + key(_k21) + _sep1 + compile(_v13);
      _c9 = ", ";
    }
  }
  return(_s9 + "}");
