var getenv = function (k, p, env) {
  var __env = env || get_environment();
  if (string63(k)) {
    var __i = edge(__env);
    while (__i >= 0) {
      var __b = __env[__i][k];
  ...
  if (atom63(lh)) {
    ...
    for (__k2 in ____o1) {
      ...
      if (__k3 === "rest") {
        ...
        __e32 = ["get", __id, ["quote", bias(__k3)]];
      }
      var __x6 = __e32;
      if (is63(__k3)) {
        var __e33;
...
var expand_local = function (__x40) {
  var ____id1 = __x40;
  var __x41 = ____id1[0];
...
var expand_function = function (__x43) {
  ...
  for (____i5 in ____o3) {
    var ____x45 = ____o3[____i5];
    var __e35;
    if (numeric63(____i5)) {
      __e35 = parseInt(____i5);
    } else {
      __e35 = ____i5;
    }
    var ____i51 = __e35;
...
var quasiquote_list = function (form, depth) {
  ...
  for (__k7 in ____o5) {
    ...
    if (! number63(__k8)) {
      ...
      if (quasisplice63(__v4, depth)) {
        __e38 = quasiexpand(__v4[1]);
      } else {
        __e38 = quasiexpand(__v4, depth);
      }
      var __v5 = __e38;
      last(__xs)[__k8] = __v5;
    }
  ...
  var ____x57 = form;
  var ____i8 = 0;
  while (____i8 < _35(____x57)) {
    var __x58 = ____x57[____i8];
...
var accessor_prefix = {".": true, "@": true, "$": true, "\\": true, ":": true};
accessor_id63 = function (x) {
  return string63(x) && accessor_prefix[char(x, 0)] && some63(char(x, 1)) && ! accessor_prefix[char(x, 1)];
};
...
compile_id = function (id, raw63) {
  ...
  var __id11 = __e41;
  var __i10 = 0;
  while (__i10 < _35(__id0)) {
    var __c1 = char(__id0, __i10);
    var __n7 = code(__c1);
    var __e43;
    if (__c1 === "-" && !( __id0 === "-")) {
      __e43 = "_";
...
valid_id63 = function (x) {
  return some63(x) && x === compile_id(x, "raw");
};
var __names = {};
unique = function (x) {
  var __x67 = compile_id(x);
  if (__names[__x67]) {
    var __i11 = __names[__x67];
...
compile_args = function (args) {
  ...
  var ____x85 = args;
  var ____i15 = 0;
  while (____i15 < _35(____x85)) {
    var __x86 = ____x85[____i15];
...
var op_delims = function (parent, child) {
  ...
  var __parent = destash33(parent, ____r61);
  var __child = destash33(child, ____r61);
  var ____id8 = ____r61;
  ...
  if (__e51(precedence(__child), precedence(__parent))) {
    return ["(", ")"];
  } else {
    return ["", ""];
  }
...
compile_function = function (args, body) {
  ...
  var ____id13 = ____r63;
  var __name3 = ____id13["name"];
  var __prefix = ____id13["prefix"];
  var __e52;
  if (__name3) {
    __e52 = compile(__name3);
  } else {
    __e52 = "";
  }
  var __id14 = __e52;
  var __e53;
  if ((target === "lua" || target === "r") && __args4["rest"]) {
    __e53 = join(__args4, ["|...|"]);
  } else {
    __e53 = __args4;
  }
...
var can_return63 = function (form) {
  return is63(form) && !( target === "r") && (atom63(form) || !( hd(form) === "return") && ! statement63(hd(form)));
};
compile = function (form) {
  var ____r65 = unstash(Array["prototype"]["slice"]["call"](arguments, 1));
...
var lower_short = function (x, args, hoist) {
  ...
  if (some63(__hoist1)) {
    ...
    return lower(["do", ["%local", __id19, __a3], __e64], hoist);
  } else {
...
var lower_for = function (args, hoist) {
  var ____id211 = args;
  var __t = ____id211[0];
  var __k13 = ____id211[1];
  var __body6 = cut(____id211, 2);
                      ...
                      if (__x134 === "while") {
                        ...
                        if (__x134 === "%for") {
                          ...
                          if (__x134 === "%function") {
                            ...
                            if (__x134 === "%local-function" || __x134 === "%global-function") {
                              return lower_definition(__x134, __args9, hoist);
                            } else {
                              if (in63(__x134, ["and", "or"])) {
                                return lower_short(__x134, __args9, hoist);
                              } else {
                                if (statement63(__x134)) {
...
setenv("do", {_stash: true, special: function () {
  ...
  var __s3 = "";
  var ____x139 = __forms1;
  var ____i19 = 0;
  while (____i19 < _35(____x139)) {
    var __x140 = ____x139[____i19];
    if (target === "lua" && immediate_call63(__x140) && "\n" === char(__s3, edge(__s3))) {
      __s3 = clip(__s3, 0, edge(__s3)) + ";\n";
    }
    __s3 = __s3 + compile(__x140, {_stash: true, stmt: true});
    if (! atom63(__x140)) {
      if (hd(__x140) === "return" || hd(__x140) === "break") {
        break;
      }
    }
    ____i19 = ____i19 + 1;
...
setenv("%block", {_stash: true, special: function () {
  ...
  var __s5 = "{\n";
  indent_level = indent_level + 1;
  var ____x145 = __forms3;
  var ____i21 = 0;
  while (____i21 < _35(____x145)) {
    var __x146 = ____x145[____i21];
    __s5 = __s5 + compile(__x146, {_stash: true, stmt: true});
    ____i21 = ____i21 + 1;
  }
  var ____x144;
  indent_level = indent_level - 1;
...
setenv("%if", {_stash: true, special: function (cond, cons, alt) {
  ...
  indent_level = indent_level + 1;
  var ____x149 = compile(cons, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var __cons1 = ____x149;
  var __e66;
  if (alt) {
    indent_level = indent_level + 1;
    var ____x150 = compile(alt, {_stash: true, stmt: true});
    indent_level = indent_level - 1;
    __e66 = ____x150;
  }
  var __alt1 = __e66;
...
setenv("%for", {_stash: true, special: function (t, k, form) {
  ...
  indent_level = indent_level + 1;
  var ____x154 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var __body12 = ____x154;
  if (target === "lua") {
...
setenv("%try", {_stash: true, special: function (form) {
  ...
  indent_level = indent_level + 1;
  var ____x159 = compile(form, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var __body14 = ____x159;
  var __hf1 = ["return", ["%array", false, __e8]];
  indent_level = indent_level + 1;
  var ____x162 = compile(__hf1, {_stash: true, stmt: true});
  indent_level = indent_level - 1;
  var __h1 = ____x162;
  return __ind9 + "try {\n" + __body14 + __ind9 + "}\n" + __ind9 + "catch (" + __e8 + ") {\n" + __h1 + __ind9 + "}\n";
}, stmt: true, tr: true});
...
setenv("%global-function", {_stash: true, special: function (name, args, body) {
  if (target === "lua") {
    var __x166 = compile_function(args, body, {_stash: true, name: name});
    return indentation() + __x166;
  } else {
...
setenv("%local-function", {_stash: true, special: function (name, args, body) {
  if (target === "lua") {
    var __x172 = compile_function(args, body, {_stash: true, name: name, prefix: "local"});
...
setenv("throw", {_stash: true, special: function (x) {
  var __e68;
  if (target === "js") {
    __e68 = "throw " + compile(x);
  } else {
    __e68 = "error(" + compile(x) + ")";
  }
  var __e12 = __e68;
...
setenv("%array", {_stash: true, special: function () {
  ...
  var __s9 = "";
  var __c7 = "";
  var ____o10 = __forms5;
  var __k16 = undefined;
  for (__k16 in ____o10) {
    var __v9 = ____o10[__k16];
    var __e80;
    if (numeric63(__k16)) {
      __e80 = parseInt(__k16);
    } else {
      __e80 = __k16;
    }
    var __k17 = __e80;
...
setenv("%object", {_stash: true, special: function () {
  ...
  var __sep5 = __e82;
  var ____o12 = pair(__forms7);
  var __k21 = undefined;
  for (__k21 in ____o12) {
    var __v12 = ____o12[__k21];
    var __e83;
    if (numeric63(__k21)) {
      __e83 = parseInt(__k21);
    } else {
      __e83 = __k21;
    }
    var __k22 = __e83;
    if (number63(__k22)) {
      ...
      __s111 = __s111 + __c9 + key(__k23) + __sep5 + compile(__v13);
      __c9 = ", ";
    }
  }
  var __e84;
