...
var special_form63 = function (form) {
  return(! atom63(form) && special63(form[0]));
};
...
var quasisplice63 = function (x, depth) {
  return(can_unquote63(depth) && ! atom63(x) && x[0] === "unquote-splicing");
};
    ...
    if (atom63(form)) {
      ...
      if (form[0] === "%local") {
        ...
        if (form[0] === "%function") {
          ...
          if (form[0] === "%global-function") {
            return(expand_definition(form));
          } else {
            if (form[0] === "%local-function") {
              return(expand_definition(form));
            } else {
              if (macro63(form[0])) {
...
var quasiquote_list = function (form, depth) {
  ...
  var pruned = keep(function (x) {
    return(_35(x) > 1 || !( x[0] === "list") || keys63(x));
  }, xs);
  if (one63(pruned)) {
    return(pruned[0]);
  } else {
...
var reserved = {"switch": true, "or": true, "in": true, "true": true, "end": true, "catch": true, ">": true, ">=": true, "<": true, "and": true, "for": true, "not": true, "break": true, "try": true, "var": true, "delete": true, "finally": true, "==": true, "/": true, "then": true, "function": true, "+": true, "nil": true, "this": true, "until": true, "debugger": true, "false": true, "instanceof": true, "local": true, "typeof": true, "%": true, "while": true, "=": true, "repeat": true, "with": true, "continue": true, "void": true, "-": true, "*": true, "throw": true, "return": true, "do": true, "default": true, "new": true, "else": true, "if": true, "elseif": true, "<=": true, "case": true};
...
var unary63 = function (form) {
  return(two63(form) && in63(form[0], ["not", "-"]));
};
...
var parenthesize_call63 = function (x) {
  return(! atom63(x) && x[0] === "%function" || precedence(x) > 0);
};
...
var can_return63 = function (form) {
  return(is63(form) && (atom63(form) || !( form[0] === "return") && ! statement63(form[0])));
};
...
var literal63 = function (form) {
  return(atom63(form) || form[0] === "%array" || form[0] === "%object");
};
var standalone63 = function (form) {
  return(! atom63(form) && ! infix63(form[0]) && ! literal63(form) && !( "get" === form[0]) || id_literal63(form));
};
...
var lower_infix63 = function (form) {
  return(infix63(form[0]) && _35(form) > 3);
};
