  ...
  if atom63(lh) then
    ...
    for __k1 in next, ____o1 do
      ...
      if __k1 == "rest" then
        ...
        local __e23
        if own63 then
          __e23 = {"if", {"has?", __id, {"quote", bias(__k1)}}, {"get", __id, {"quote", bias(__k1)}}}
        else
...
function bind42(args, body)
  ...
  if atom63(args) then
    ...
    if keys63(args) then
      ...
      local ____x38 = __args1
      local ____i4 = 0
      while ____i4 < _35(____x38) do
        local __v3 = ____x38[____i4 + 1]
        __bs1 = join(__bs1, {__v3, {"destash!", __v3, __r19}})
        ____i4 = ____i4 + 1
      end
      __ks = join(__ks, {keys(args), __r19})
    end
    local ____x44 = {"let", __ks}
    ____x44.own = true
...
local function expand_local(__x45)
  local ____id1 = __x45
  local __x46 = ____id1[1]
  local __name = ____id1[2]
  local __value = ____id1[3]
  setenv(__name, {_stash = true, variable = true})
  return({"%local", __name, macroexpand(__value)})
end
local function expand_function(__x48)
  local ____id2 = __x48
  local __x49 = ____id2[1]
  ...
  for ____i5 in next, ____o3 do
    local ____x50 = ____o3[____i5]
    setenv(____x50, {_stash = true, variable = true})
  end
  local ____x51 = join({"%function", __args}, macroexpand(__body))
  drop(environment)
  return(____x51)
end
local function expand_definition(__x53)
  local ____id3 = __x53
  local __x54 = ____id3[1]
  ...
  for ____i6 in next, ____o4 do
    local ____x55 = ____o4[____i6]
    setenv(____x55, {_stash = true, variable = true})
  end
  local ____x56 = join({__x54, __name1, __args11}, macroexpand(__body1))
  drop(environment)
  return(____x56)
end
  ...
  if symbol63(form) then
    ...
    if atom63(form) then
      ...
      if __x59 == "%local" then
        ...
        if __x59 == "%function" then
          return(expand_function(form))
        else
          if __x59 == "%global-function" then
            return(expand_definition(form))
          else
            if __x59 == "%local-function" then
              return(expand_definition(form))
            else
              if macro63(__x59) then
...
local function quasiquote_list(form, depth)
  ...
  local ____x62 = form
  local ____i8 = 0
  while ____i8 < _35(____x62) do
    local __x63 = ____x62[____i8 + 1]
    if quasisplice63(__x63, depth) then
      local __x64 = quasiexpand(__x63[2])
      add(__xs, __x64)
      add(__xs, {"list"})
    else
...
function unique(x)
  local __x72 = id(x)
  if __names[__x72] then
    local __i11 = __names[__x72]
...
____x87.lua = "or"
____x86["or"] = ____x87
local infix = {____x75, ____x77, ____x78, ____x80, ____x81, ____x82, ____x84, ____x86}
...
local function compile_args(args)
  ...
  local ____x90 = args
  local ____i15 = 0
  while ____i15 < _35(____x90) do
    local __x91 = ____x90[____i15 + 1]
...
local function compile_special(form, stmt63)
  local ____id6 = form
  local __x92 = ____id6[1]
  local __args2 = cut(____id6, 1)
  local ____id7 = getenv(__x92)
...
function compile_function(args, body, ...)
  ...
  local ____x98 = compile(__body3, {_stash = true, stmt = true})
  indent_level = indent_level - 1
  local __body4 = ____x98
...
local function lower_do(args, hoist, stmt63, tail63)
  local ____x105 = almost(args)
  local ____i17 = 0
  while ____i17 < _35(____x105) do
    local __x106 = ____x105[____i17 + 1]
    local ____y = lower(__x106, hoist, stmt63)
    if yes(____y) then
      local __e1 = ____y
...
local function lower_while(args, hoist)
  ...
  if none63(__pre) then
    __e46 = {"while", __c5, lower_body(__body5)}
  else
    __e46 = {"while", true, join({"do"}, __pre, {{"%if", {"not", __c5}, {"break"}}, lower_body(__body5)})}
  end
...
setenv("do", {_stash = true, special = function (...)
  ...
  local ____i19 = 0
  while ____i19 < _35(____x147) do
    local __x148 = ____x147[____i19 + 1]
