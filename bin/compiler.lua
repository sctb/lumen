      ...
      if __k1 == "rest" then
        ...
        if number63(__k1) then
          ...
          if not own63 then
            ...
            __e24 = {"if", {"has?", __id, {"quote", __k1}}, {"get", __id, {"quote", __k1}}}
          end
          __e23 = __e24
        end
        __e22 = __e23
    ...
    for __k3 in next, ____o2 do
      ...
      if number63(__k3) then
        if atom63(__v2) then
          ...
          local __x37 = unique("x")
          add(__args1, __x37)
          __bs1 = join(__bs1, {__v2, __x37})
        end
      end
    end
    if keys63(args) then
      __bs1 = join(__bs1, {__r19, rest()})
      local ____x40 = __args1
      local ____i4 = 0
      while ____i4 < _35(____x40) do
        local __v3 = ____x40[____i4 + 1]
        __bs1 = join(__bs1, {__v3, {"destash!", __v3, __r19}})
        ____i4 = ____i4 + 1
      end
      __bs1 = join(__bs1, {keys(args), __r19})
    end
    local ____x45 = {"let", __bs1}
    ____x45.own = true
    return({__args1, join(____x45, body)})
  end
end
...
local function expand_local(__x46)
  local ____id1 = __x46
  local __x47 = ____id1[1]
  local __name = ____id1[2]
  local __value = ____id1[3]
  setenv(__name, {_stash = true, variable = true})
  return({"%local", __name, macroexpand(__value)})
end
local function expand_function(__x49)
  local ____id2 = __x49
  local __x50 = ____id2[1]
  ...
  for ____i5 in next, ____o3 do
    local ____x51 = ____o3[____i5]
    setenv(____x51, {_stash = true, variable = true})
  end
  local ____x52 = join({"%function", __args}, macroexpand(__body))
  drop(environment)
  return(____x52)
end
local function expand_definition(__x54)
  local ____id3 = __x54
  local __x55 = ____id3[1]
  ...
  for ____i6 in next, ____o4 do
    local ____x56 = ____o4[____i6]
    setenv(____x56, {_stash = true, variable = true})
  end
  local ____x57 = join({__x55, __name1, __args11}, macroexpand(__body1))
  drop(environment)
  return(____x57)
end
  ...
  if symbol63(form) then
    ...
    if atom63(form) then
      ...
      if __x60 == "%local" then
        ...
        if __x60 == "%function" then
          return(expand_function(form))
        else
          if __x60 == "%global-function" then
            return(expand_definition(form))
          else
            if __x60 == "%local-function" then
              return(expand_definition(form))
            else
              if macro63(__x60) then
...
local function quasiquote_list(form, depth)
  ...
  local ____x63 = form
  local ____i8 = 0
  while ____i8 < _35(____x63) do
    local __x64 = ____x63[____i8 + 1]
    if quasisplice63(__x64, depth) then
      local __x65 = quasiexpand(__x64[2])
      add(__xs, __x65)
      add(__xs, {"list"})
    else
      add(last(__xs), quasiexpand(__x64, depth))
    end
    ____i8 = ____i8 + 1
  end
...
local function id(id)
  ...
  while __i10 < _35(id) do
    ...
    local __n6 = code(__c1)
    local __e28
    if __c1 == "-" and not( id == "-") then
      __e28 = "_"
    else
      local __e29
      if valid_code63(__n6) then
        __e29 = __c1
      else
        local __e30
        if __i10 == 0 then
...
function unique(x)
  local __x73 = id(x)
  if __names[__x73] then
    local __i11 = __names[__x73]
    __names[__x73] = __names[__x73] + 1
    return(unique(__x73 .. __i11))
  else
    __names[__x73] = 1
    return("__" .. __x73)
  end
...
____x88.lua = "or"
____x87["or"] = ____x88
local infix = {____x76, ____x78, ____x79, ____x81, ____x82, ____x83, ____x85, ____x87}
...
local function compile_special(form, stmt63)
  local ____id6 = form
  local __x93 = ____id6[1]
  local __args2 = cut(____id6, 1)
  local ____id7 = getenv(__x93)
...
function compile_function(args, body, ...)
  ...
  local ____x99 = compile(__body3, {_stash = true, stmt = true})
  indent_level = indent_level - 1
  local __body4 = ____x99
...
local function lower_do(args, hoist, stmt63, tail63)
  ...
  local ____i17 = 0
  while ____i17 < _35(____x106) do
    local __x107 = ____x106[____i17 + 1]
                    ...
                    if __x142 == "%for" then
                      ...
                      if __x142 == "%function" then
                        ...
                        if __x142 == "%local-function" or __x142 == "%global-function" then
                          return(lower_definition(__x142, __args9, hoist))
                        else
...
setenv("do", {_stash = true, special = function (...)
  ...
  local __s3 = ""
  local ____x148 = __forms1
  local ____i19 = 0
  while ____i19 < _35(____x148) do
    local __x149 = ____x148[____i19 + 1]
    if target == "lua" and immediate_call63(__x149) and "\n" == char(__s3, edge(__s3)) then
      __s3 = clip(__s3, 0, edge(__s3)) .. ";\n"
    end
    __s3 = __s3 .. compile(__x149, {_stash = true, stmt = true})
    if not atom63(__x149) then
      if hd(__x149) == "return" or hd(__x149) == "break" then
        break
      end
    end
    ____i19 = ____i19 + 1
...
setenv("%if", {_stash = true, special = function (cond, cons, alt)
  ...
  indent_level = indent_level + 1
  local ____x152 = compile(cons, {_stash = true, stmt = true})
  indent_level = indent_level - 1
  local __cons1 = ____x152
  local __e48
  if alt then
    indent_level = indent_level + 1
    local ____x153 = compile(alt, {_stash = true, stmt = true})
    indent_level = indent_level - 1
    __e48 = ____x153
  end
  local __alt1 = __e48
...
setenv("%try", {_stash = true, special = function (form)
  ...
  indent_level = indent_level + 1
  local ____x162 = compile(form, {_stash = true, stmt = true})
  indent_level = indent_level - 1
  local __body14 = ____x162
  local __hf1 = {"return", {"%array", false, __e8}}
  indent_level = indent_level + 1
  local ____x165 = compile(__hf1, {_stash = true, stmt = true})
  indent_level = indent_level - 1
  local __h1 = ____x165
  return(__ind9 .. "try {\n" .. __body14 .. __ind9 .. "}\n" .. __ind9 .. "catch (" .. __e8 .. ") {\n" .. __h1 .. __ind9 .. "}\n")
end, stmt = true, tr = true})
...
setenv("%global-function", {_stash = true, special = function (name, args, body)
  if target == "lua" then
    local __x169 = compile_function(args, body, {_stash = true, name = name})
...
setenv("%local-function", {_stash = true, special = function (name, args, body)
  if target == "lua" then
    local __x175 = compile_function(args, body, {_stash = true, name = name, prefix = "local"})
