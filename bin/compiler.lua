...
local reserved = {["/"] = true, ["-"] = true, ["elseif"] = true, ["nil"] = true, ["this"] = true, ["do"] = true, ["<="] = true, ["case"] = true, ["repeat"] = true, [">="] = true, ["finally"] = true, ["then"] = true, ["in"] = true, ["else"] = true, ["break"] = true, ["with"] = true, [">"] = true, ["<"] = true, ["void"] = true, ["instanceof"] = true, ["return"] = true, ["default"] = true, ["typeof"] = true, ["until"] = true, ["delete"] = true, ["function"] = true, ["catch"] = true, ["debugger"] = true, ["or"] = true, ["=="] = true, ["not"] = true, ["local"] = true, ["var"] = true, ["while"] = true, ["continue"] = true, ["end"] = true, ["throw"] = true, ["false"] = true, ["try"] = true, ["*"] = true, ["and"] = true, ["switch"] = true, ["new"] = true, ["if"] = true, ["%"] = true, ["for"] = true, ["true"] = true, ["="] = true, ["+"] = true}
...
setenv("do", stash33({tr = true, stmt = true, special = function (...)
  local forms = unstash({...})
  local s = ""
  local _x112 = forms
...
setenv("%if", stash33({tr = true, stmt = true, special = function (cond, cons, alt)
  local _cond1 = compile(cond)
  indent_level = indent_level + 1
  local _x115 = compile(cons, stash33({stmt = true}))
  indent_level = indent_level - 1
  local _cons1 = _x115
  local _e27
  if alt then
    indent_level = indent_level + 1
    local _x116 = compile(alt, stash33({stmt = true}))
    indent_level = indent_level - 1
    _e27 = _x116
  end
  local _alt1 = _e27
...
setenv("while", stash33({tr = true, stmt = true, special = function (cond, form)
  local _cond3 = compile(cond)
  indent_level = indent_level + 1
  local _x118 = compile(form, stash33({stmt = true}))
  indent_level = indent_level - 1
  local body = _x118
  local ind = indentation()
  if target == "js" then
...
setenv("%for", stash33({tr = true, stmt = true, special = function (t, k, form)
  local _t1 = compile(t)
  local ind = indentation()
  indent_level = indent_level + 1
  local _x120 = compile(form, stash33({stmt = true}))
  indent_level = indent_level - 1
  local body = _x120
  if target == "lua" then
...
setenv("%try", stash33({tr = true, stmt = true, special = function (form)
  local e = unique("e")
  local ind = indentation()
  indent_level = indent_level + 1
  ...
  indent_level = indent_level + 1
  local _x132 = compile(hf, stash33({stmt = true}))
  indent_level = indent_level - 1
  local h = _x132
  return(ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n")
end}))
...
setenv("%global-function", stash33({tr = true, stmt = true, special = function (name, args, body)
  if target == "lua" then
...
setenv("%local-function", stash33({tr = true, stmt = true, special = function (name, args, body)
  if target == "lua" then
