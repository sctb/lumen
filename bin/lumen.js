...
join = function () {
  ...
  var __x1_ = _ls;
  var __i4_ = 0;
  while (__i4_ < _35(__x1_)) {
    var _l11 = __x1_[__i4_];
    if (_l11) {
      var _n3 = _35(_r37);
      var __o2_ = _l11;
      var _k4 = undefined;
...
empty63 = function (t) {
  var __o6_ = t;
  var __i12_ = undefined;
  for (__i12_ in __o6_) {
    var _x7 = __o6_[__i12_];
    var _e9;
    if (numeric63(__i12_)) {
      _e9 = parseInt(__i12_);
    } else {
                ...
                if (function63(x)) {
                  ...
                  if (stack && in63(x, stack)) {
                    ...
                    if (false) {
                      ...
                      drop(_l4);
                      var __o11_ = join(_xs11, _ks);
                      var __i22_ = undefined;
                      for (__i22_ in __o11_) {
                        var _v10 = __o11_[__i22_];
                        var _e17;
                        if (numeric63(__i22_)) {
                          _e17 = parseInt(__i22_);
                        } else {
                          _e17 = __i22_;
                        }
                        var __i221_ = _e17;
...
call = function (f) {
  var __r74_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _f = destash33(f, __r74_);
  var __id_ = __r74_;
  var _args11 = cut(__id_, 0);
  return(apply(_f, _args11));
};
setenv = function (k) {
  var __r75_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _k18 = destash33(k, __r75_);
  var __id1_ = __r75_;
  var _keys = cut(__id1_, 0);
  if (string63(_k18)) {
    var _e18;
    if (_keys.toplevel) {
      _e18 = hd(environment);
...
setenv("case", {_stash: true, macro: function (expr) {
  var __r13_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _expr1 = destash33(expr, __r13_);
  var __id4_ = __r13_;
  var _clauses1 = cut(__id4_, 0);
  var _x41 = unique("x");
  var _eq1 = function (_) {
    return(["=", ["quote", _], _x41]);
  };
...
setenv("when", {_stash: true, macro: function (cond) {
  var __r17_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _cond1 = destash33(cond, __r17_);
  var __id7_ = __r17_;
  var _body3 = cut(__id7_, 0);
  return(["if", _cond1, join(["do"], _body3)]);
}});
setenv("unless", {_stash: true, macro: function (cond) {
  var __r19_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _cond3 = destash33(cond, __r19_);
  var __id9_ = __r19_;
  var _body5 = cut(__id9_, 0);
...
setenv("let", {_stash: true, macro: function (bs) {
  var __r23_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _bs11 = destash33(bs, __r23_);
  var __id14_ = __r23_;
  var _body9 = cut(__id14_, 0);
  if (atom63(_bs11)) {
    ...
    if (none63(_bs11)) {
      ...
      var _lh3 = __id15_[0];
      var _rh3 = __id15_[1];
      var _bs21 = cut(__id15_, 2);
      var __id16_ = bind(_lh3, _rh3);
      var _id17 = __id16_[0];
      var _val1 = __id16_[1];
      var _bs12 = cut(__id16_, 2);
      var _renames1 = [];
...
setenv("with", {_stash: true, macro: function (x, v) {
  var __r25_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _x84 = destash33(x, __r25_);
  var _v3 = destash33(v, __r25_);
  var __id19_ = __r25_;
  var _body11 = cut(__id19_, 0);
  return(join(["let", [_x84, _v3]], _body11, [_x84]));
}});
setenv("let-when", {_stash: true, macro: function (x, v) {
  var __r27_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _x94 = destash33(x, __r27_);
  var _v5 = destash33(v, __r27_);
  var __id21_ = __r27_;
  var _body13 = cut(__id21_, 0);
  var _y1 = unique("y");
  return(["let", _y1, _v5, ["when", ["yes", _y1], join(["let", [_x94, _y1]], _body13)]]);
}});
setenv("define-macro", {_stash: true, macro: function (name, args) {
  var __r29_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _name1 = destash33(name, __r29_);
  var _args3 = destash33(args, __r29_);
  var __id23_ = __r29_;
  var _body15 = cut(__id23_, 0);
  var __x103_ = ["setenv", ["quote", _name1]];
  __x103_.macro = join(["fn", _args3], _body15);
  var _form1 = __x103_;
  eval(_form1);
  return(_form1);
}});
setenv("define-special", {_stash: true, macro: function (name, args) {
  var __r31_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _name3 = destash33(name, __r31_);
  var _args5 = destash33(args, __r31_);
  var __id25_ = __r31_;
  var _body17 = cut(__id25_, 0);
  var __x109_ = ["setenv", ["quote", _name3]];
  __x109_.special = join(["fn", _args5], _body17);
  var _form3 = join(__x109_, keys(_body17));
  eval(_form3);
  return(_form3);
}});
setenv("define-symbol", {_stash: true, macro: function (name, expansion) {
  setenv(name, {_stash: true, symbol: expansion});
  var __x115_ = ["setenv", ["quote", name]];
  __x115_.symbol = ["quote", expansion];
  return(__x115_);
}});
setenv("define-reader", {_stash: true, macro: function (_x123) {
  var __id28_ = _x123;
  var _char1 = __id28_[0];
  var _s1 = __id28_[1];
  var __r35_ = unstash(Array.prototype.slice.call(arguments, 1));
  var __x123_ = destash33(_x123, __r35_);
  var __id29_ = __r35_;
  var _body19 = cut(__id29_, 0);
  return(["set", ["get", "read-table", _char1], join(["fn", [_s1]], _body19)]);
}});
setenv("define", {_stash: true, macro: function (name, x) {
  var __r37_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _name5 = destash33(name, __r37_);
  var _x131 = destash33(x, __r37_);
  var __id31_ = __r37_;
  var _body21 = cut(__id31_, 0);
...
setenv("define-global", {_stash: true, macro: function (name, x) {
  var __r39_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _name7 = destash33(name, __r39_);
  var _x137 = destash33(x, __r39_);
  var __id33_ = __r39_;
  var _body23 = cut(__id33_, 0);
...
setenv("with-bindings", {_stash: true, macro: function (_x159) {
  var __id36_ = _x159;
  var _names1 = __id36_[0];
  var __r41_ = unstash(Array.prototype.slice.call(arguments, 1));
  var __x159_ = destash33(_x159, __r41_);
  var __id37_ = __r41_;
  var _body27 = cut(__id37_, 0);
  var _x160 = unique("x");
  var __x163_ = ["setenv", _x160];
  __x163_.variable = true;
  return(join(["with-frame", ["each", _x160, _names1, __x163_]], _body27));
}});
setenv("let-macro", {_stash: true, macro: function (definitions) {
  var __r44_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _definitions1 = destash33(definitions, __r44_);
  var __id39_ = __r44_;
  var _body29 = cut(__id39_, 0);
  add(environment, {});
  map(function (m) {
    return(macroexpand(join(["define-macro"], m)));
  }, _definitions1);
  var __x167_ = join(["do"], macroexpand(_body29));
  drop(environment);
  return(__x167_);
}});
setenv("let-symbol", {_stash: true, macro: function (expansions) {
  var __r48_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _expansions1 = destash33(expansions, __r48_);
  var __id42_ = __r48_;
  var _body31 = cut(__id42_, 0);
  add(environment, {});
  map(function (_x175) {
    var __id43_ = _x175;
    var _name9 = __id43_[0];
    var _exp1 = __id43_[1];
    return(macroexpand(["define-symbol", _name9, _exp1]));
  }, pair(_expansions1));
  var __x174_ = join(["do"], macroexpand(_body31));
  drop(environment);
  return(__x174_);
}});
setenv("let-unique", {_stash: true, macro: function (names) {
  var __r52_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _names3 = destash33(names, __r52_);
  var __id45_ = __r52_;
  var _body33 = cut(__id45_, 0);
...
setenv("fn", {_stash: true, macro: function (args) {
  var __r55_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _args7 = destash33(args, __r55_);
  var __id47_ = __r55_;
  var _body35 = cut(__id47_, 0);
  return(join(["%function"], bind42(_args7, _body35)));
}});
setenv("apply", {_stash: true, macro: function (f) {
  var __r57_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _f1 = destash33(f, __r57_);
  var __id49_ = __r57_;
  var _args9 = cut(__id49_, 0);
  if (_35(_args9) > 1) {
...
setenv("guard", {_stash: true, macro: function (expr) {
  if (target === "js") {
    ...
    var __x253_ = ["obj"];
    __x253_.message = _msg1;
    __x253_.stack = _trace1;
    return(["let", [_x231, "nil", _msg1, "nil", _trace1, "nil"], ["if", ["xpcall", ["fn", join(), ["set", _x231, expr]], ["fn", ["m"], ["set", _trace1, [["get", "debug", ["quote", "traceback"]]], _msg1, ["if", ["string?", "m"], ["clip", "m", ["+", ["search", "m", "\": \""], 2]], ["nil?", "m"], "\"\"", ["str", "m"]]]]], ["list", true, _x231], ["list", false, __x253_]]]);
  }
}});
setenv("each", {_stash: true, macro: function (x, t) {
  var __r61_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _x268 = destash33(x, __r61_);
  var _t1 = destash33(t, __r61_);
  var __id52_ = __r61_;
  var _body37 = cut(__id52_, 0);
  var _o3 = unique("o");
  var _n3 = unique("n");
  var _i3 = unique("i");
  var _e9;
...
setenv("for", {_stash: true, macro: function (i, to) {
  var __r63_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _i5 = destash33(i, __r63_);
  var _to1 = destash33(to, __r63_);
  var __id55_ = __r63_;
  var _body39 = cut(__id55_, 0);
  return(["let", _i5, 0, join(["while", ["<", _i5, _to1]], _body39, [["inc", _i5]])]);
}});
setenv("step", {_stash: true, macro: function (v, t) {
  var __r65_ = unstash(Array.prototype.slice.call(arguments, 2));
  var _v9 = destash33(v, __r65_);
  var _t3 = destash33(t, __r65_);
  var __id57_ = __r65_;
  var _body41 = cut(__id57_, 0);
  var _x300 = unique("x");
  var _i7 = unique("i");
...
setenv("join!", {_stash: true, macro: function (a) {
  var __r69_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _a3 = destash33(a, __r69_);
  var __id59_ = __r69_;
  var _bs5 = cut(__id59_, 0);
  return(["set", _a3, join(["join", _a3], _bs5)]);
}});
setenv("cat!", {_stash: true, macro: function (a) {
  var __r71_ = unstash(Array.prototype.slice.call(arguments, 1));
  var _a5 = destash33(a, __r71_);
  var __id61_ = __r71_;
  var _bs7 = cut(__id61_, 0);
...
setenv("export", {_stash: true, macro: function () {
  ...
  if (target === "js") {
    ...
    var _x351 = {};
    var __o7_ = _names5;
    var __i11_ = undefined;
    for (__i11_ in __o7_) {
      var _k7 = __o7_[__i11_];
      var _e15;
      if (numeric63(__i11_)) {
        _e15 = parseInt(__i11_);
      } else {
        _e15 = __i11_;
      }
      var __i111_ = _e15;
...
var main = function () {
  ...
  if (_arg && script_file63(_arg)) {
    ...
    if (_arg === "-h" || _arg === "--help") {
      ...
      var __x2_ = _pre;
      var __i1_ = 0;
      while (__i1_ < _35(__x2_)) {
        var _file = __x2_[__i1_];
        run_file(_file);
        __i1_ = __i1_ + 1;
      }
      if (nil63(_input)) {
