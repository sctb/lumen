...
setenv = function (k) {
  var _u137 = unstash(Array.prototype.slice.call(arguments, 1));
  var keys = sub(_u137, 0);
  if (string63(k)) {
    var _u159;
    if (keys.toplevel) {
      _u159 = hd(environment);
    } else {
      _u159 = last(environment);
    }
    var frame = _u159;
    var entry = frame[k] || {};
    var _u138 = keys;
