...
setenv("let", {_stash: true, macro: function (bs) {
  ...
  if (atom63(__bs11) || vector63(__bs11)) {
    ...
    if (none63(__bs11)) {
      ...
      var __renames1 = [];
      if (vector63(__id17)) {
        var __id131 = [hd(__id17)];
        var ____x80 = tl(__id17);
        var ____i3 = 0;
        while (____i3 < _35(____x80)) {
          var __x81 = ____x80[____i3];
          var __x121 = unique(__x81);
          __renames1 = join(__renames1, [__x81, __x121]);
          add(__id131, __x121);
          ____i3 = ____i3 + 1;
        }
        __id17 = __id131;
...
setenv("let-when", {_stash: true, macro: function (x, v) {
  ...
  var __x102 = destash33(x, ____r27);
  var __v5 = destash33(v, ____r27);
  var ____id21 = ____r27;
  var __body13 = cut(____id21, 0);
  var __y1 = unique("y");
  return(["let", __y1, __v5, ["when", ["yes", __y1], join(["let", [__x102, __y1]], __body13)]]);
}});
setenv("define-macro", {_stash: true, macro: function (name, args) {
  ...
  var ____x1111 = ["setenv", ["quote", __name1]];
  ____x1111.macro = join(["fn", __args3], __body15);
  var __form1 = ____x1111;
  eval(__form1);
  return(__form1);
}});
setenv("define-special", {_stash: true, macro: function (name, args) {
  ...
  var ____x117 = ["setenv", ["quote", __name3]];
  ____x117.special = join(["fn", __args5], __body17);
  var __form3 = join(____x117, keys(__body17));
  eval(__form3);
  return(__form3);
}});
setenv("define-symbol", {_stash: true, macro: function (name, expansion) {
  setenv(name, {_stash: true, symbol: expansion});
  var ____x123 = ["setenv", ["quote", name]];
  ____x123.symbol = ["quote", expansion];
  return(____x123);
}});
setenv("define-reader", {_stash: true, macro: function (__x131) {
  var ____id28 = __x131;
  var __char1 = ____id28[0];
  var __s1 = ____id28[1];
  var ____r35 = unstash(Array.prototype.slice.call(arguments, 1));
  var ____x131 = destash33(__x131, ____r35);
...
setenv("define", {_stash: true, macro: function (name, x) {
  ...
  var __x139 = destash33(x, ____r37);
  var ____id31 = ____r37;
  var __body21 = cut(____id31, 0);
  setenv(__name5, {_stash: true, variable: true});
  if (some63(__body21)) {
    return(join(["%local-function", __name5], bind42(__x139, __body21)));
  } else {
    return(["%local", __name5, __x139]);
  }
}});
setenv("define-global", {_stash: true, macro: function (name, x) {
  ...
  if (some63(__body23)) {
    return(join(["%global-function", __name7], bind42(__x145, __body23)));
  } else {
    return(["set", __name7, __x145]);
  }
}});
setenv("with-frame", {_stash: true, macro: function () {
  var __body25 = unstash(Array.prototype.slice.call(arguments, 0));
  var __x155 = unique("x");
  return(["do", ["add", "environment", ["obj"]], ["with", __x155, join(["do"], __body25), ["drop", "environment"]]]);
}});
setenv("with-bindings", {_stash: true, macro: function (__x167) {
  var ____id36 = __x167;
  var __names1 = ____id36[0];
  var ____r41 = unstash(Array.prototype.slice.call(arguments, 1));
  var ____x167 = destash33(__x167, ____r41);
  var ____id37 = ____r41;
  var __body27 = cut(____id37, 0);
  var __x168 = unique("x");
  var ____x171 = ["setenv", __x168];
  ____x171.variable = true;
  return(join(["with-frame", ["each", __x168, __names1, ____x171]], __body27));
}});
setenv("let-macro", {_stash: true, macro: function (definitions) {
  ...
  var ____x175 = join(["do"], macroexpand(__body29));
  drop(environment);
  return(____x175);
}});
setenv("let-symbol", {_stash: true, macro: function (expansions) {
  ...
  var ____x182 = join(["do"], macroexpand(__body31));
  drop(environment);
  return(____x182);
}});
...
setenv("guard", {_stash: true, macro: function (expr) {
  if (target === "js") {
    ...
    var __x239 = unique("x");
    var __msg1 = unique("msg");
    var __trace1 = unique("trace");
    var ____x261 = ["obj"];
    ____x261.message = __msg1;
    ____x261.stack = __trace1;
    return(["let", [__x239, "nil", __msg1, "nil", __trace1, "nil"], ["if", ["xpcall", ["fn", join(), ["set", __x239, expr]], ["fn", ["m"], ["set", __trace1, [["get", "debug", ["quote", "traceback"]]], __msg1, ["if", ["string?", "m"], ["clip", "m", ["+", ["search", "m", "\": \""], 2]], ["nil?", "m"], "\"\"", ["str", "m"]]]]], ["list", true, __x239], ["list", false, ____x261]]]);
  }
}});
setenv("each", {_stash: true, macro: function (x, t) {
  var ____r61 = unstash(Array.prototype.slice.call(arguments, 2));
  var __x276 = destash33(x, ____r61);
...
setenv("step", {_stash: true, macro: function (v, t) {
  ...
  var __x308 = unique("x");
  var __i9 = unique("i");
  return(["let", [__x308, __t3], ["for", __i9, ["#", __x308], join(["let", [__v9, ["at", __x308, __i9]]], __body41)]]);
}});
setenv("set-of", {_stash: true, macro: function () {
  ...
  for (____i11 in ____o5) {
    var __x318 = ____o5[____i11];
    var __e12;
    if (numeric63(____i11)) {
      __e12 = parseInt(____i11);
    } else {
      __e12 = ____i11;
    }
    var ____i111 = __e12;
...
setenv("with-indent", {_stash: true, macro: function (form) {
  var __x343 = unique("x");
  return(["do", ["inc", "indent-level"], ["with", __x343, form, ["dec", "indent-level"]]]);
}});
setenv("export", {_stash: true, macro: function () {
  ...
  if (target === "js") {
    ...
    for (____i13 in ____o7) {
      var __k7 = ____o7[____i13];
      var __e15;
      if (numeric63(____i13)) {
        __e15 = parseInt(____i13);
      } else {
        __e15 = ____i13;
      }
      var ____i131 = __e15;
