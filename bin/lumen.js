            ...
            if (boolean63(x)) {
              ...
              if (function63(x)) {
                ...
                if (atom63(x)) {
                  ...
                  var _u114 = join(xs, ks);
                  var _u5 = undefined;
                  for (_u5 in _u114) {
                    var v = _u114[_u5];
                    var _u115 = parseInt(_u5);
                    var _u148;
                    if (isNaN(_u115)) {
                      _u148 = _u5;
                    } else {
...
apply = function (f, args) {
  var _u123 = stash(args);
  return(f.apply(f, _u123));
};
var _u124 = 0;
unique = function () {
  _u124 = _u124 + 1;
...
setenv = function (k) {
  var _u129 = unstash(Array.prototype.slice.call(arguments, 1));
  var keys = cut(_u129, 0);
  if (string63(k)) {
    var _u149;
    if (keys.toplevel) {
