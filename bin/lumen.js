...
(function () {
  ...
  global.modules = {"lumen/reader": {export: {"make-stream": {export: true, variable: true}, "read-table": {export: true, variable: true}, "define-reader": {export: true, macro: function (_g978) {
    ...
    return(str + "}");
  }}}, import: [["lumen", "runtime"], ["lumen", "special"], ["lumen", "core"], ["lumen", "lib"], ["lumen", "compiler"]]}, "lumen/core": {export: {quote: {export: true, macro: function (form) {
    return(quoted(form));
