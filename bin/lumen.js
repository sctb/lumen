...
setenv("let", {_stash: true, macro: function (bs) {
  ...
  while (some63(__bs11)) {
    ...
    var ____id16 = bind(__lh3, macroexpand(__rh3));
...
setenv("define-macro", {_stash: true, macro: function (name, args) {
  ...
  ____x95.macro = join(["fn", __args3], __body15);
  var __form1 = ____x95;
  _eval(__form1);
  return __form1;
}});
setenv("define-special", {_stash: true, macro: function (name, args) {
  ...
  var ____x101 = ["setenv", ["quote", __name3]];
  ____x101.special = join(["fn", __args5], __body17);
  var __form3 = join(____x101, keys(__body17));
  _eval(__form3);
  return __form3;
}});
...
setenv("define-reader", {_stash: true, macro: function (__x115) {
  ...
  var ____x115 = destash33(__x115, ____r35);
...
setenv("with-bindings", {_stash: true, macro: function (__x151) {
  ...
  var ____x151 = destash33(__x151, ____r41);
  var ____id37 = ____r41;
  var __body27 = cut(____id37, 0);
  var __x152 = unique("x");
  var ____x155 = ["setenv", __x152];
  ____x155.variable = true;
  return join(["with-frame", ["each", __x152, __names1, ____x155]], __body27);
}});
setenv("let-macro", {_stash: true, macro: function (definitions) {
  ...
  var ____x159 = join(["do"], macroexpand(__body29));
  drop(environment);
  return ____x159;
}});
setenv("let-symbol", {_stash: true, macro: function (expansions) {
  ...
  var ____x166 = join(["do"], macroexpand(__body31));
  drop(environment);
  return ____x166;
}});
...
setenv("guard", {_stash: true, macro: function (expr) {
  if (target === "js") {
    ...
    var ____x221 = ["obj"];
    ____x221.stack = [["get", "debug", ["quote", "traceback"]]];
    ____x221.message = ["if", ["string?", "m"], ["clip", "m", ["+", ["search", "m", "\": \""], 2]], ["nil?", "m"], "\"\"", ["str", "m"]];
    return ["list", ["xpcall", ["fn", join(), expr], ["fn", ["m"], ["if", ["obj?", "m"], "m", ____x221]]]];
  }
}});
setenv("each", {_stash: true, macro: function (x, t) {
  var ____r61 = unstash(Array.prototype.slice.call(arguments, 2));
  var __x246 = destash33(x, ____r61);
...
setenv("step", {_stash: true, macro: function (v, t) {
  ...
  var __x278 = unique("x");
  var __i7 = unique("i");
  return ["let", [__x278, __t3], ["for", __i7, ["#", __x278], join(["let", [__v9, ["at", __x278, __i7]]], __body41)]];
}});
...
setenv("with-indent", {_stash: true, macro: function (form) {
  var __x313 = unique("x");
  return ["do", ["inc", "indent-level"], ["with", __x313, form, ["dec", "indent-level"]]];
}});
