  ...
  if composite63(lh) and list63(rh) then
    ...
    if atom63(lh) then
      ...
      for k in next, _u33 do
        ...
        local _u147
        if k == "rest" then
          _u147 = {"sub", rh, length(lh)}
        else
          _u147 = {"get", rh, {"quote", bias(k)}}
        end
        local x = _u147
        local _u148
        if v == true then
  ...
  for k in next, _u87 do
    ...
    if not number63(k) then
      ...
      if quasisplice63(v, depth) then
        _u149 = quasiexpand(v[2])
      else
        _u149 = quasiexpand(v, depth)
      end
      local _u89 = _u149
      last(xs)[k] = _u89
    end
...
reserved = {["return"] = true, ["-"] = true, ["/"] = true, ["new"] = true, ["delete"] = true, ["function"] = true, ["%"] = true, ["=="] = true, ["and"] = true, ["debugger"] = true, ["true"] = true, ["end"] = true, ["nil"] = true, ["do"] = true, ["break"] = true, ["finally"] = true, ["="] = true, ["this"] = true, ["for"] = true, ["*"] = true, ["typeof"] = true, ["var"] = true, ["then"] = true, ["if"] = true, ["false"] = true, [">="] = true, ["with"] = true, ["<="] = true, ["continue"] = true, ["until"] = true, ["default"] = true, ["local"] = true, ["elseif"] = true, ["in"] = true, ["or"] = true, ["case"] = true, ["not"] = true, ["catch"] = true, ["while"] = true, ["repeat"] = true, ["instanceof"] = true, ["void"] = true, ["+"] = true, ["try"] = true, ["else"] = true, ["<"] = true, ["throw"] = true, [">"] = true, ["switch"] = true}
...
setenv("with-frame", {_stash = true, macro = function (...)
  local _u128 = unstash({...})
  local scope = _u128.scope
  local body = sub(_u128, 0)
  local x = unique()
  local _u132 = {"table"}
  _u132._scope = scope
  return({"do", {"add", "environment", _u132}, {"let", {x, join({"do"}, body)}, {"drop", "environment"}, x}})
end})
setenv("with-bindings", {_stash = true, macro = function (_u145, ...)
  local names = _u145[1]
  local _u144 = unstash({...})
  local body = sub(_u144, 0)
  local x = unique()
  local _u150 = {"setenv", x}
  _u150.variable = true
  local _u147 = {"with-frame", {"all", {"_u1", x}, names, _u150}}
  _u147.scope = true
  return(join(_u147, body))
end})
setenv("let-macro", {_stash = true, macro = function (definitions, ...)
  local _u157 = unstash({...})
  local body = sub(_u157, 0)
  add(environment, {})
  map(function (m)
    return(macroexpand(join({"define-macro"}, m)))
  end, definitions)
  local _u159 = join({"do"}, macroexpand(body))
  drop(environment)
  return(_u159)
end})
setenv("let-symbol", {_stash = true, macro = function (expansions, ...)
  ...
  local _u172 = join({"do"}, macroexpand(body))
  drop(environment)
  return(_u172)
end})
setenv("fn", {_stash = true, macro = function (args, ...)
  local _u183 = unstash({...})
  local body = sub(_u183, 0)
  local _u185 = bind42(args, body)
  local _u186 = _u185[1]
  local _u187 = _u185[2]
...
setenv("all", {_stash = true, macro = function (_u226, t, ...)
  local k = _u226[1]
  local v = _u226[2]
  local _u225 = unstash({...})
  ...
  if target == "lua" then
    ...
    _u292 = {join({"let", {n, {"parseInt", k}, k, {"if", {"isNaN", n}, k, n}}}, body)}
  end
  return({"let", {x, t, k, "nil"}, {"%for", x, k, join({"let", {v, {"get", x, k}}}, _u292)}})
end})
