...
(function ()
  ...
  local reserved = {["*"] = true, ["new"] = true, ["for"] = true, ["break"] = true, ["this"] = true, [">"] = true, ["<"] = true, ["throw"] = true, ["debugger"] = true, ["until"] = true, ["switch"] = true, ["instanceof"] = true, ["with"] = true, ["<="] = true, ["then"] = true, ["=="] = true, ["local"] = true, ["false"] = true, ["nil"] = true, ["-"] = true, ["while"] = true, ["repeat"] = true, ["/"] = true, ["+"] = true, ["else"] = true, ["="] = true, ["default"] = true, ["function"] = true, ["try"] = true, ["elseif"] = true, ["end"] = true, ["and"] = true, ["delete"] = true, ["finally"] = true, ["void"] = true, ["or"] = true, ["typeof"] = true, ["var"] = true, ["catch"] = true, ["true"] = true, ["do"] = true, ["case"] = true, ["in"] = true, ["return"] = true, ["not"] = true, ["if"] = true, ["continue"] = true, ["%"] = true, [">="] = true}
...
(function ()
  ...
  modules = {["lumen/special"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "compiler"}}, export = {["%array"] = {special = function (...)
    local forms = unstash({...})
    local _g759
    if target == "lua" then
      _g759 = "{"
  ...
  end, foo = true, export = true}, ["%if"] = {stmt = true, special = function (cond, cons, alt)
  ...
  end, export = true, tr = true, foo = true}, ["do"] = {stmt = true, special = function (...)
    local forms = unstash({...})
    local str = ""
    local _g696 = forms
    local _g697 = 0
    ...
    return(str)
  end, export = true, tr = true, foo = true}, ["return"] = {stmt = true, special = function (x)
    local _g763
    if nil63(x) then
      _g763 = "return"
    else
  ...
  end, foo = true, export = true}, ["%for"] = {stmt = true, special = function (t, k, form)
  ...
  end, export = true, tr = true, foo = true}, ["%local"] = {stmt = true, special = function (name, value)
  ...
  end, foo = true, export = true}, ["while"] = {stmt = true, special = function (cond, form)
  ...
  end, export = true, tr = true, foo = true}, ["not"] = {}, ["%object"] = {special = function (...)
    local forms = unstash({...})
    local str = "{"
    local _g766
    if target == "lua" then
    ...
    return(str .. "}")
  end, foo = true, export = true}, ["%local-function"] = {stmt = true, special = function (name, args, body)
    local x = compile_function(args, body, {_stash = true, name = name, prefix = "local "})
    return(indentation() .. x)
  end, export = true, tr = true, foo = true}, get = {special = function (t, k)
    local _g705 = compile(t)
    local k1 = compile(k)
    if target == "lua" and char(_g705, 0) == "{" then
      _g705 = "(" .. _g705 .. ")"
    end
    if string_literal63(k) and valid_id63(inner(k)) then
      return(_g705 .. "." .. inner(k))
    else
      return(_g705 .. "[" .. k1 .. "]")
    end
  ...
  end, export = true, tr = true, foo = true}, set = {stmt = true, special = function (lh, rh)
  ...
  end, foo = true, export = true}, ["%try"] = {stmt = true, special = function (form)
    local ind = indentation()
    indent_level = indent_level + 1
    ...
    local h = _g709
    return(ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n")
  end, export = true, tr = true, foo = true}, ["%function"] = {special = function (args, body)
    return(compile_function(args, body))
  end, foo = true, export = true}, ["break"] = {stmt = true, special = function ()
    return(indentation() .. "break")
  end, foo = true, export = true}}}, ["lumen/boot"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "compiler"}}, export = {["%initial-modules"] = {macro = function ()
    return(quote_modules())
  end}, ["%initial-environment"] = {macro = function ()
    return(quote_environment(initial_environment()))
  end}, modules = {global = true, export = true}}}, lumen = {alias = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, import = {{"lumen", "special"}}, export = {}}, user = {import = {"lumen", {"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, export = {}}, ["lumen/runtime"] = {import = {{"lumen", "special"}, {"lumen", "core"}}, export = {join = {variable = true, export = true}, cos = {variable = true, export = true}, ["is?"] = {variable = true, export = true}, ["splice?"] = {variable = true}, drop = {variable = true, export = true}, ["%message-handler"] = {variable = true, export = true}, flat = {variable = true, export = true}, sqrt = {variable = true, export = true}, ["table?"] = {variable = true, export = true}, exit = {variable = true, export = true}, ["empty?"] = {variable = true, export = true}, abs = {variable = true, export = true}, last = {variable = true, export = true}, asin = {variable = true, export = true}, log = {variable = true, export = true}, ["<="] = {variable = true, export = true}, ["read-file"] = {variable = true, export = true}, [">="] = {variable = true, export = true}, atan2 = {variable = true, export = true}, sinh = {variable = true, export = true}, ["keys?"] = {variable = true, export = true}, reduce = {variable = true, export = true}, ["in?"] = {variable = true, export = true}, tanh = {variable = true, export = true}, ["atom?"] = {variable = true, export = true}, find = {variable = true, export = true}, length = {variable = true, export = true}, ["boolean?"] = {variable = true, export = true}, keep = {variable = true, export = true}, now = {variable = true, export = true}, atan = {variable = true, export = true}, pow = {variable = true, export = true}, ["number?"] = {variable = true, export = true}, ["function?"] = {variable = true, export = true}, tan = {variable = true, export = true}, ["make-id"] = {variable = true, export = true}, ["id-count"] = {variable = true}, mapl = {variable = true}, unstash = {variable = true, export = true}, ["list?"] = {variable = true, export = true}, pair = {variable = true, export = true}, number = {variable = true, export = true}, subl = {variable = true}, ["min*"] = {variable = true}, ["max*"] = {variable = true}, map = {variable = true, export = true}, acos = {variable = true, export = true}, module = {variable = true, export = true}, math = {variable = true}, code = {variable = true, export = true}, clock = {variable = true, export = true}, splice = {variable = true, export = true}, setenv = {variable = true, export = true}, ["module-key"] = {variable = true, export = true}, today = {variable = true, export = true}, ["toplevel?"] = {variable = true, export = true}, apply = {variable = true, export = true}, flat1 = {variable = true, export = true}, replicate = {variable = true, export = true}, ["none?"] = {variable = true, export = true}, ["write-file"] = {variable = true, export = true}, inner = {variable = true, export = true}, sin = {variable = true, export = true}, log10 = {variable = true, export = true}, add = {variable = true, export = true}, hd = {variable = true, export = true}, sub = {variable = true, export = true}, exclude = {variable = true, export = true}, sort = {variable = true, export = true}, space = {variable = true, export = true}, search = {variable = true, export = true}, ["id-literal?"] = {variable = true, export = true}, ["-"] = {variable = true, export = true}, ["%"] = {variable = true, export = true}, reverse = {variable = true, export = true}, ceil = {variable = true, export = true}, cat = {variable = true, export = true}, split = {variable = true, export = true}, ["string-literal?"] = {variable = true, export = true}, ["+"] = {variable = true, export = true}, ["string?"] = {variable = true, export = true}, ["composite?"] = {variable = true, export = true}, stash = {variable = true, export = true}, floor = {variable = true, export = true}, ["*"] = {variable = true, export = true}, write = {variable = true, export = true}, string = {variable = true, export = true}, iterate = {variable = true, export = true}, max = {variable = true, export = true}, char = {variable = true, export = true}, substring = {variable = true, export = true}, ["/"] = {variable = true, export = true}, ["some?"] = {variable = true, export = true}, ["nil?"] = {variable = true, export = true}, ["<"] = {variable = true, export = true}, tl = {variable = true, export = true}, [">"] = {variable = true, export = true}, ["="] = {variable = true, export = true}, min = {variable = true, export = true}, extend = {variable = true, export = true}, ["one?"] = {variable = true, export = true}, random = {variable = true, export = true}}}, ["lumen/compiler"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "reader"}}, export = {["%result"] = {global = true, export = true}, ["compile-infix"] = {variable = true}, ["lower-definition"] = {variable = true}, ["lower-short"] = {variable = true}, ["open-module"] = {variable = true, export = true}, ["lower-try"] = {variable = true}, ["compile-special"] = {variable = true}, getop = {variable = true}, conclude = {variable = true}, declare = {variable = true, export = true}, ["load-module"] = {variable = true, export = true}, ["%compile-module"] = {variable = true}, eval = {variable = true, export = true}, ["compile-call"] = {variable = true}, compile = {variable = true, export = true}, ["current-module"] = {global = true, export = true}, ["lower-statement"] = {variable = true}, ["parenthesize-call?"] = {variable = true}, ["import-modules"] = {variable = true, export = true}, encapsulate = {variable = true}, ["compile-function"] = {variable = true, export = true}, reimported = {variable = true}, ["compiler-output"] = {variable = true}, ["compile-atom"] = {variable = true}, ["compiling?"] = {variable = true}, ["lower-body"] = {variable = true}, ["compile-file"] = {variable = true}, ["lower-function"] = {variable = true}, ["infix?"] = {variable = true}, lower = {variable = true}, ["lower-special"] = {variable = true}, precedence = {variable = true}, infix = {variable = true}, process = {variable = true}, ["module-path"] = {variable = true}, terminator = {variable = true}, ["compile-args"] = {variable = true}, ["lower-infix"] = {variable = true}, ["can-return?"] = {variable = true}, ["lower-infix?"] = {variable = true}, ["lower-call"] = {variable = true}, ["lower-for"] = {variable = true}, ["op-delims"] = {variable = true}, ["lower-do"] = {variable = true}, ["lower-while"] = {variable = true}, ["lower-if"] = {variable = true}, run = {variable = true}, ["compile-module"] = {variable = true, export = true}, ["in-module"] = {variable = true, export = true}, ["unary?"] = {variable = true}}}, ["lumen/main"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "reader"}, {"lumen", "compiler"}}, export = {}}, ["lumen/lib"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, export = {quasiexpand = {variable = true, export = true}, ["macro?"] = {variable = true, export = true}, escape = {variable = true}, ["bind*"] = {variable = true, export = true}, ["with-indent"] = {macro = function (form)
    local result = make_id()
    return({"do", {"inc", "indent-level"}, {"let", {result, form}, {"dec", "indent-level"}, result}})
  end, export = true}, ["symbol?"] = {variable = true, export = true}, ["global?"] = {variable = true}, ["bound?"] = {variable = true, export = true}, ["quasiquote-list"] = {variable = true}, ["symbol-expansion"] = {variable = true, export = true}, macroexpand = {variable = true, export = true}, ["reserved?"] = {variable = true, export = true}, ["quote-environment"] = {variable = true, export = true}, quoted = {variable = true, export = true}, id = {variable = true, export = true}, indentation = {variable = true, export = true}, ["quasisplice?"] = {variable = true}, ["stash*"] = {variable = true, export = true}, mapo = {variable = true, export = true}, bind = {variable = true, export = true}, key = {variable = true, export = true}, reserved = {variable = true}, ["quote-module"] = {variable = true}, ["initial-environment"] = {variable = true, export = true}, ["quote-frame"] = {variable = true}, ["quote-binding"] = {variable = true}, ["special?"] = {variable = true, export = true}, ["valid-code?"] = {variable = true}, imported = {variable = true, export = true}, literal = {variable = true}, ["special-form?"] = {variable = true, export = true}, ["variable?"] = {variable = true, export = true}, ["can-unquote?"] = {variable = true}, ["quasiquoting?"] = {variable = true}, ["indent-level"] = {global = true, export = true}, ["statement?"] = {variable = true, export = true}, ["quote-modules"] = {variable = true, export = true}, linked = {variable = true, export = true}, ["numeric?"] = {variable = true}, ["quoting?"] = {variable = true}, ["valid-id?"] = {variable = true, export = true}, getenv = {variable = true, export = true}, ["macro-function"] = {variable = true, export = true}}}, ["lumen/system"] = {import = {{"lumen", "special"}, {"lumen", "core"}}, export = {nexus = {global = true, export = true}}}, ["lumen/core"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "compiler"}}, export = {["with-bindings"] = {macro = function (_g710, ...)
    local names = _g710[1]
    local body = unstash({...})
    local _g711 = sub(body, 0)
    local x = make_id()
    local _g713 = {"setenv", x}
    _g713.variable = true
    local _g712 = {"with-frame", {"each", {x}, names, _g713}}
    _g712.scope = true
    ...
    if some63(_g716) and target == "js" then
    ...
    if some63(_g722) then
      local _g723 = bind42(x, _g722)
      local args = _g723[1]
      local _g724 = _g723[2]
    ...
    local _g735 = join({"do"}, macroexpand(_g734))
    drop(environment)
    return(_g735)
  end, export = true}, ["define-module"] = {macro = function (spec, ...)
    local body = unstash({...})
    local _g737 = sub(body, 0)
    local alias = _g737.alias
    local exp = _g737.export
    local imp = _g737.import
    local _g738 = import_modules(imp)
    local imports = _g738[1]
    local bindings = _g738[2]
    local k = module_key(spec)
    ...
    return({"if", {"not", cond}, join({"do"}, _g745)})
    ...
    if length(bindings) < 2 then
      ...
      local lh = bindings[1]
      local rh = bindings[2]
      local _g747 = bind(lh, rh)
      local _g748 = 0
      while _g748 < length(_g747) do
        local _g749 = _g747[_g748 + 1]
        local id = _g749[1]
        local val = _g749[2]
    ...
    local form = join({"fn", args}, _g751)
    local keys = sub(_g751, length(_g751))
    local _g752 = {"setenv", {"quote", name}}
    ...
    return({"set", n, {"+", n, by or 1}})
  end, export = true}}}, ["lumen/reader"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, export = {["skip-non-code"] = {variable = true}, delimiters = {variable = true}, ["peek-char"] = {variable = true}, ["read-all"] = {variable = true, export = true}, ["read-char"] = {variable = true}, whitespace = {variable = true}, ["read-table"] = {variable = true, export = true}, ["read-from-string"] = {variable = true, export = true}, eof = {variable = true}, ["flag?"] = {variable = true}, ["define-reader"] = {macro = function (_g753, ...)
    local char = _g753[1]
    local stream = _g753[2]
    local body = unstash({...})
    local _g754 = sub(body, 0)
    return({"set", {"get", "read-table", char}, join({"fn", {stream}}, _g754)})
  end, export = true}, ["key?"] = {variable = true}, read = {variable = true, export = true}, ["make-stream"] = {variable = true, export = true}}}}
