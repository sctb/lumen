...
(function ()
  ...
  local reserved = {["default"] = true, ["and"] = true, ["true"] = true, ["debugger"] = true, ["break"] = true, ["%"] = true, ["do"] = true, ["throw"] = true, [">"] = true, ["<"] = true, [">="] = true, ["try"] = true, ["switch"] = true, ["continue"] = true, ["function"] = true, ["return"] = true, ["nil"] = true, ["then"] = true, ["false"] = true, ["while"] = true, ["local"] = true, ["if"] = true, ["instanceof"] = true, ["catch"] = true, ["typeof"] = true, ["in"] = true, ["or"] = true, ["end"] = true, ["case"] = true, ["="] = true, ["delete"] = true, ["*"] = true, ["this"] = true, ["void"] = true, ["repeat"] = true, ["not"] = true, ["until"] = true, ["elseif"] = true, ["var"] = true, ["with"] = true, ["=="] = true, ["-"] = true, ["finally"] = true, ["+"] = true, ["else"] = true, ["new"] = true, ["<="] = true, ["for"] = true, ["/"] = true}
...
(function ()
  ...
  modules = {utilities = {export = {["bind*"] = {variable = true, export = true}, ["initial-environment"] = {variable = true, export = true}, mapo = {variable = true, export = true}, quoted = {variable = true, export = true}, ["global?"] = {variable = true}, ["quasiquote-list"] = {variable = true}, ["bound?"] = {variable = true, export = true}, ["stash*"] = {variable = true, export = true}, ["quote-module"] = {variable = true}, ["reserved?"] = {variable = true, export = true}, bind = {variable = true, export = true}, imported = {variable = true, export = true}, ["quasiquoting?"] = {variable = true}, ["with-indent"] = {macro = function (form)
    local result = make_id()
    return({"do", {"inc", "indent-level"}, {"let", {result, form}, {"dec", "indent-level"}, result}})
  end, export = true}, ["macro-function"] = {variable = true, export = true}, ["quote-environment"] = {variable = true, export = true}, ["quoting?"] = {variable = true}, ["valid-id?"] = {variable = true, export = true}, quasiexpand = {variable = true, export = true}, ["special-form?"] = {variable = true, export = true}, exported = {variable = true, export = true}, ["quote-frame"] = {variable = true}, ["quote-binding"] = {variable = true}, ["valid-char?"] = {variable = true}, ["can-unquote?"] = {variable = true}, reserved = {variable = true}, ["special?"] = {variable = true, export = true}, ["symbol-expansion"] = {variable = true, export = true}, ["numeric?"] = {variable = true}, escape = {variable = true}, ["symbol?"] = {variable = true, export = true}, ["quasisplice?"] = {variable = true}, getenv = {variable = true, export = true}, indentation = {variable = true, export = true}, ["indent-level"] = {global = true, export = true}, ["macro?"] = {variable = true, export = true}, ["statement?"] = {variable = true, export = true}, ["quote-modules"] = {variable = true, export = true}, ["toplevel?"] = {variable = true, export = true}, macroexpand = {variable = true, export = true}, ["variable?"] = {variable = true, export = true}, ["to-id"] = {variable = true, export = true}}, import = {"runtime", "special", "core"}}, compiler = {export = {run = {variable = true}, getop = {variable = true}, ["load-module"] = {variable = true, export = true}, ["lower-infix"] = {variable = true}, ["compiler-output"] = {variable = true}, ["lower-if"] = {variable = true}, ["op-delims"] = {variable = true}, ["lower-function"] = {variable = true}, ["lower-try"] = {variable = true}, ["compile-special"] = {variable = true}, terminator = {variable = true}, prologue = {variable = true}, ["unary?"] = {variable = true}, ["current-module"] = {global = true, export = true}, ["can-return?"] = {variable = true}, ["%compile-module"] = {variable = true}, ["lower-infix?"] = {variable = true}, ["compiling?"] = {variable = true}, infix = {variable = true}, ["open-module"] = {variable = true, export = true}, ["%result"] = {global = true, export = true}, ["lower-definition"] = {variable = true}, encapsulate = {variable = true}, ["infix?"] = {variable = true}, ["module-path"] = {variable = true}, ["in-module"] = {variable = true, export = true}, ["lower-body"] = {variable = true}, process = {variable = true}, ["lower-short"] = {variable = true}, ["lower-for"] = {variable = true}, ["compile-args"] = {variable = true}, ["compile-infix"] = {variable = true}, ["lower-call"] = {variable = true}, ["parenthesize-call?"] = {variable = true}, ["compile-function"] = {variable = true, export = true}, lower = {variable = true, export = true, global = true}, ["compile-file"] = {variable = true}, ["lower-statement"] = {variable = true}, ["compile-call"] = {variable = true}, ["lower-do"] = {variable = true}, ["lower-while"] = {variable = true}, ["lower-special"] = {variable = true}, ["compile-atom"] = {variable = true}, compile = {variable = true, export = true}, ["compile-module"] = {variable = true, export = true}, eval = {variable = true, export = true}, precedence = {variable = true}}, import = {"runtime", "utilities", "special", "core", "reader"}}, optimizer = {export = {optimize = {variable = true, export = true}, optimizations = {variable = true}, ["define-optimization"] = {}}, import = {"runtime", "special", "core"}}, system = {export = {nexus = {global = true, export = true}}, import = {"special", "core"}}, lib = {export = {}, import = {"core", "special"}}, runtime = {export = {hd = {variable = true, export = true}, ["keys?"] = {variable = true, export = true}, sublist = {variable = true, export = true}, find = {variable = true, export = true}, module = {variable = true, export = true}, exclude = {variable = true, export = true}, pairwise = {variable = true, export = true}, ["nil?"] = {variable = true, export = true}, extend = {variable = true, export = true}, ["%"] = {variable = true, export = true}, inner = {variable = true, export = true}, code = {variable = true, export = true}, last = {variable = true, export = true}, ["some?"] = {variable = true, export = true}, ["string-literal?"] = {variable = true, export = true}, ["table?"] = {variable = true, export = true}, ["boolean?"] = {variable = true, export = true}, write = {variable = true, export = true}, reverse = {variable = true, export = true}, replicate = {variable = true, export = true}, ["make-id"] = {variable = true, export = true}, ["function?"] = {variable = true, export = true}, map = {variable = true, export = true}, split = {variable = true, export = true}, mapl = {variable = true}, splice = {variable = true, export = true}, length = {variable = true, export = true}, cat = {variable = true, export = true}, ["toplevel?"] = {variable = true, export = true}, ["module-key"] = {variable = true, export = true}, ["in?"] = {variable = true, export = true}, stash = {variable = true, export = true}, search = {variable = true, export = true}, ["string?"] = {variable = true, export = true}, ["id-count"] = {variable = true}, ["write-file"] = {variable = true, export = true}, ["number?"] = {variable = true, export = true}, ["splice?"] = {variable = true}, iterate = {variable = true, export = true}, setenv = {variable = true, export = true}, ["%message-handler"] = {variable = true, export = true}, substring = {variable = true, export = true}, ["/"] = {variable = true, export = true}, apply = {variable = true, export = true}, ["to-string"] = {variable = true, export = true}, add = {variable = true, export = true}, ["parse-number"] = {variable = true, export = true}, exit = {variable = true, export = true}, tl = {variable = true, export = true}, drop = {variable = true, export = true}, [">="] = {variable = true, export = true}, ["atom?"] = {variable = true, export = true}, ["list?"] = {variable = true, export = true}, reduce = {variable = true, export = true}, ["+"] = {variable = true, export = true}, ["*"] = {variable = true, export = true}, char = {variable = true, export = true}, ["<="] = {variable = true, export = true}, ["empty?"] = {variable = true, export = true}, ["none?"] = {variable = true, export = true}, ["read-file"] = {variable = true, export = true}, ["composite?"] = {variable = true, export = true}, [">"] = {variable = true, export = true}, unstash = {variable = true, export = true}, ["-"] = {variable = true, export = true}, sub = {variable = true, export = true}, ["id-literal?"] = {variable = true, export = true}, keep = {variable = true, export = true}, ["="] = {variable = true, export = true}, ["<"] = {variable = true, export = true}, ["is?"] = {variable = true, export = true}, join = {variable = true, export = true}}, import = {"special", "core"}}, main = {export = {save = {macro = function (...)
    local specs = unstash({...})
    local _g641 = sub(specs, 0)
    map(compile_module, _g641)
    return(nil)
  end}}, import = {"runtime", "special", "core", "reader", "compiler"}}, boot = {export = {["%initial-modules"] = {macro = function ()
    return(quote_modules())
  end}, modules = {global = true, export = true}, ["%initial-environment"] = {macro = function ()
    return(quote_environment(initial_environment()))
  end}}, import = {"runtime", "utilities", "special", "core", "compiler"}}, reader = {export = {["peek-char"] = {variable = true}, ["read-all"] = {variable = true, export = true}, whitespace = {variable = true}, ["read-table"] = {variable = true, export = true}, ["key?"] = {variable = true}, ["make-stream"] = {variable = true, export = true}, eof = {variable = true}, ["skip-non-code"] = {variable = true}, ["flag?"] = {variable = true}, ["read-char"] = {variable = true}, ["read-from-string"] = {variable = true, export = true}, read = {variable = true, export = true}, delimiters = {variable = true}, ["define-reader"] = {macro = function (_g642, ...)
    local char = _g642[1]
    local stream = _g642[2]
    local body = unstash({...})
    local _g643 = sub(body, 0)
    return({"set", {"get", "read-table", char}, join({"fn", {stream}}, _g643)})
  end, export = true}}, import = {"runtime", "special", "core"}}, special = {export = {["%try"] = {foo = true, tr = true, stmt = true, export = true, special = function (form)
    local ind = indentation()
    indent_level = indent_level + 1
    ...
    indent_level = indent_level + 1
    local _g645 = compile(hf, {_stash = true, stmt = true})
    indent_level = indent_level - 1
    local h = _g645
    return(ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n")
  end}, ["%object"] = {foo = true, special = function (...)
    local forms = unstash({...})
    local str = "{"
    local _g712
    if target == "lua" then
    ...
    local _g646 = pairs
    local i = 0
    while i < length(_g646) do
      local _g647 = _g646[i + 1]
      local k = _g647[1]
      local v = _g647[2]
      if not string63(k) then
        error("Illegal key: " .. to_string(k))
      end
      local _g648 = compile(v)
      local _g713
    ...
    return(str .. "}")
  end, export = true}, ["%global-function"] = {foo = true, tr = true, stmt = true, export = true, special = function (name, args, body)
    if target == "lua" then
    ...
    while _g651 < length(_g650) do
      local x = _g650[_g651 + 1]
      str = str .. compile(x, {_stash = true, stmt = true})
      _g651 = _g651 + 1
    end
    return(str)
  end}, ["%function"] = {foo = true, special = function (args, body)
    return(compile_function(args, body))
  end, export = true}, ["return"] = {foo = true, export = true, special = function (x)
    local _g717
    if nil63(x) then
      _g717 = "return"
    else
    ...
    local _g652 = _g717
    return(indentation() .. _g652)
  end, stmt = true}, ["%local-function"] = {foo = true, tr = true, stmt = true, export = true, special = function (name, args, body)
    local x = compile_function(args, body, {_stash = true, name = name, prefix = "local "})
    return(indentation() .. x)
  end}, ["%for"] = {foo = true, tr = true, stmt = true, export = true, special = function (t, k, form)
    local _g653 = compile(t)
    local ind = indentation()
    indent_level = indent_level + 1
    ...
    local body = _g654
    if target == "lua" then
      return(ind .. "for " .. k .. " in next, " .. _g653 .. " do\n" .. body .. ind .. "end\n")
    else
      return(ind .. "for (" .. k .. " in " .. _g653 .. ") {\n" .. body .. ind .. "}\n")
    end
  ...
  end}, ["set"] = {foo = true, export = true, special = function (lh, rh)
    local _g657 = compile(lh)
    local _g718
    if nil63(rh) then
      _g718 = "nil"
    else
    ...
    local _g658 = compile(_g718)
    return(indentation() .. _g657 .. " = " .. _g658)
  ...
  end, stmt = true}, ["%if"] = {foo = true, tr = true, stmt = true, export = true, special = function (cond, cons, alt)
    local _g659 = compile(cond)
    indent_level = indent_level + 1
    local _g662 = compile(cons, {_stash = true, stmt = true})
    indent_level = indent_level - 1
    local _g660 = _g662
    local _g721
    if alt then
      indent_level = indent_level + 1
      local _g663 = compile(alt, {_stash = true, stmt = true})
      indent_level = indent_level - 1
      _g721 = _g663
    end
    local _g661 = _g721
    ...
    local str = ""
    if target == "js" then
      str = str .. ind .. "if (" .. _g659 .. ") {\n" .. _g660 .. ind .. "}"
    else
      str = str .. ind .. "if " .. _g659 .. " then\n" .. _g660
    end
    if _g661 and target == "js" then
      str = str .. " else {\n" .. _g661 .. ind .. "}"
    else
      if _g661 then
        str = str .. ind .. "else\n" .. _g661
  ...
  end}, ["not"] = {}, ["%array"] = {foo = true, special = function (...)
    local forms = unstash({...})
    local _g722
    if target == "lua" then
      _g722 = "{"
    ...
    local k1 = compile(k)
    if target == "lua" and char(_g665, 0) == "{" then
      _g665 = "(" .. _g665 .. ")"
    end
    if string_literal63(k) and valid_id63(inner(k)) then
      return(_g665 .. "." .. inner(k))
    else
      return(_g665 .. "[" .. k1 .. "]")
    end
  end, export = true}, ["error"] = {foo = true, export = true, special = function (x)
    local _g724
    if target == "js" then
  ...
  end, stmt = true}}, import = {"runtime", "utilities", "special", "core", "compiler"}}, core = {export = {guard = {macro = function (expr)
    if target == "js" then
  ...
  end, export = true, global = true}, fn = {macro = function (args, ...)
    local body = unstash({...})
    local _g670 = sub(body, 0)
    local _g671 = bind42(args, _g670)
    local _g672 = _g671[1]
    local _g673 = _g671[2]
    return(join({"%function", _g672}, _g673))
  end, export = true}, quasiquote = {macro = function (form)
    return(quasiexpand(form, 1))
  end, export = true}, ["with-bindings"] = {macro = function (_g674, ...)
    local names = _g674[1]
    local body = unstash({...})
    local _g675 = sub(body, 0)
    local x = make_id()
    local _g677 = {"setenv", x}
    _g677.variable = true
    local _g676 = {"with-frame", {"each", {x}, names, _g677}}
    _g676.scope = true
    return(join(_g676, _g675))
    ...
    if nil63(v) then
      ...
      local i = _g726
      _g725 = {"let", {i, 0}, {"while", {"<", i, {"length", t1}}, join({"let", {k, {"at", t1, i}}}, _g685), {"inc", i}}}
    else
      local _g686 = {"target"}
      _g686.js = {"isNaN", {"parseInt", k}}
      _g686.lua = {"not", {"number?", k}}
      _g725 = {"let", {k, "nil"}, {"%for", t1, k, {"when", _g686, join({"let", {v, {"get", t1, k}}}, _g685)}}}
    end
    ...
    local _g688 = {"table"}
    _g688._scope = scope
    return({"do", {"add", "environment", _g688}, {"let", {x, join({"do"}, _g687)}, {"drop", "environment"}, x}})
    ...
    if some63(_g689) then
      local _g690 = bind42(x, _g689)
      local args = _g690[1]
      local _g691 = _g690[2]
      return(join({"%global-function", name, args}, _g691))
    else
      if target == "js" then
    ...
    local xs = unstash({...})
    local _g692 = map(function (x)
      return(splice({{"to-string", x}, "\" \""}))
    end, xs)
    return({"print", join({"cat"}, _g692)})
    ...
    local _g694 = join({"do"}, macroexpand(_g693))
    drop(environment)
    return(_g694)
    ...
    local imports = {}
    local exp = _g696.export
    local imp = _g696.import
    local _g697 = imp or {}
    local _g698 = 0
    ...
    local l = {}
    local _g701 = elements
    local _g702 = 0
    while _g702 < length(_g701) do
      local e = _g701[_g702 + 1]
      l[e] = true
      _g702 = _g702 + 1
    end
    return(join({"table"}, l))
    ...
    map(function (_g704)
      local lh = _g704[1]
      local rh = _g704[2]
      local _g705 = bind(lh, rh)
      local _g706 = 0
      while _g706 < length(_g705) do
        local _g707 = _g705[_g706 + 1]
        local id = _g707[1]
        local val = _g707[2]
    ...
    return({"if", cond, join({"do"}, _g711)})
  end, export = true}}, import = {"runtime", "utilities", "special", "core", "compiler"}}}
