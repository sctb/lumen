...
setenv("define-special", {_stash = true, macro = function (name, args, ...)
  ...
  _x87.special = join({"fn", args}, body)
  local form = join(_x87, keys(body))
  eval(form)
  return(form)
end})
setenv("define-symbol", {_stash = true, macro = function (name, expansion)
  setenv(name, {_stash = true, symbol = expansion})
  local _x93 = {"setenv", {"quote", name}}
  _x93.symbol = {"quote", expansion}
  return(_x93)
end})
setenv("define-reader", {_stash = true, macro = function (_x101, ...)
  local char = _x101[1]
  local s = _x101[2]
  local _r29 = unstash({...})
...
setenv("with-frame", {_stash = true, macro = function (...)
  ...
  local scope = _r35.scope
  local x = unique("x")
  local _x126 = {"obj"}
  _x126._scope = scope
  return({"do", {"add", "environment", _x126}, {"let", x, join({"do"}, body), {"drop", "environment"}, x}})
end})
setenv("with-bindings", {_stash = true, macro = function (_x134, ...)
  local names = _x134[1]
  local _r37 = unstash({...})
  local body = cut(_r37, 0)
  local x = unique("x")
  local _x138 = {"setenv", x}
  _x138.variable = true
  local _x136 = {"with-frame", {"each", x, names, _x138}}
  _x136.scope = true
  return(join(_x136, body))
end})
setenv("let-fn", {_stash = true, macro = function (_x142, ...)
  local name = _x142[1]
  local args = _x142[2]
  local fn_body = cut(_x142, 2)
  local _r39 = unstash({...})
...
setenv("let-macro", {_stash = true, macro = function (definitions, ...)
  ...
  local _x150 = join({"do"}, macroexpand(body))
  drop(environment)
  return(_x150)
end})
setenv("let-symbol", {_stash = true, macro = function (expansions, ...)
  ...
  local _x158 = join({"do"}, macroexpand(body))
  drop(environment)
  return(_x158)
end})
