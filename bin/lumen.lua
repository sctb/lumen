...
setenv("let", {_stash = true, macro = function (bs, ...)
  ...
  if atom63(__bs11) or vector63(__bs11) then
    ...
    if none63(__bs11) then
      ...
      local __renames1 = {}
      if vector63(__id17) then
        local __id131 = {hd(__id17)}
        local ____x88 = tl(__id17)
        local ____i3 = 0
        while ____i3 < _35(____x88) do
          local __x89 = ____x88[____i3 + 1]
          local __x121 = unique(__x89)
          __renames1 = join(__renames1, {__x89, __x121})
          add(__id131, __x121)
          ____i3 = ____i3 + 1
        end
        __id17 = __id131
        ...
        if not id_literal63(__id17) then
          local __id141 = unique(__id17)
          __renames1 = {__id17, __id141}
          __id17 = __id141
        end
      end
...
setenv("define-macro", {_stash = true, macro = function (name, args, ...)
  ...
  local ____x122 = {"setenv", {"quote", __name1}}
  ____x122.macro = join({"fn", __args3}, __body15)
  local __form1 = ____x122
  eval(__form1)
  return(__form1)
end})
setenv("define-special", {_stash = true, macro = function (name, args, ...)
  ...
  local ____x129 = {"setenv", {"quote", __name3}}
  ____x129.special = join({"fn", __args5}, __body17)
  local __form3 = join(____x129, keys(__body17))
  eval(__form3)
  return(__form3)
end})
setenv("define-symbol", {_stash = true, macro = function (name, expansion)
  setenv(name, {_stash = true, symbol = expansion})
  local ____x135 = {"setenv", {"quote", name}}
  ____x135.symbol = {"quote", expansion}
  return(____x135)
end})
setenv("define-reader", {_stash = true, macro = function (__x143, ...)
  local ____id28 = __x143
  local __char1 = ____id28[1]
  local __s1 = ____id28[2]
  local ____r35 = unstash({...})
  local ____x143 = destash33(__x143, ____r35)
...
setenv("define-global", {_stash = true, macro = function (name, x, ...)
  ...
  if some63(__body23) then
    return(join({"%global-function", __name7}, bind42(__x160, __body23)))
  else
    return({"set", __name7, __x160})
  end
end})
setenv("with-frame", {_stash = true, macro = function (...)
  local __body25 = unstash({...})
  local __x171 = unique("x")
  return({"do", {"add", "environment", {"obj"}}, {"with", __x171, join({"do"}, __body25), {"drop", "environment"}}})
end})
setenv("with-bindings", {_stash = true, macro = function (__x183, ...)
  local ____id36 = __x183
  local __names1 = ____id36[1]
  local ____r41 = unstash({...})
  local ____x183 = destash33(__x183, ____r41)
  local ____id37 = ____r41
  local __body27 = cut(____id37, 0)
  local __x185 = unique("x")
  local ____x188 = {"setenv", __x185}
  ____x188.variable = true
  return(join({"with-frame", {"each", __x185, __names1, ____x188}}, __body27))
end})
setenv("let-macro", {_stash = true, macro = function (definitions, ...)
  ...
  local ____x193 = join({"do"}, macroexpand(__body29))
  drop(environment)
  return(____x193)
end})
...
setenv("guard", {_stash = true, macro = function (expr)
  if target == "js" then
    ...
    local __x261 = unique("x")
    local __msg1 = unique("msg")
    local __trace1 = unique("trace")
    local ____x283 = {"obj"}
    ____x283.message = __msg1
    ____x283.stack = __trace1
    return({"let", {__x261, "nil", __msg1, "nil", __trace1, "nil"}, {"if", {"xpcall", {"fn", join(), {"set", __x261, expr}}, {"fn", {"m"}, {"set", __trace1, {{"get", "debug", {"quote", "traceback"}}}, __msg1, {"if", {"string?", "m"}, {"clip", "m", {"+", {"search", "m", "\": \""}, 2}}, {"nil?", "m"}, "\"\"", {"str", "m"}}}}}, {"list", true, __x261}, {"list", false, ____x283}}})
  end
end})
setenv("each", {_stash = true, macro = function (x, t, ...)
  local ____r61 = unstash({...})
  local __x299 = destash33(x, ____r61)
  ...
  local __i5 = unique("i")
  local __e8
  if atom63(__x299) then
    __e8 = {__i5, __x299}
  else
    local __e9
    if _35(__x299) > 1 then
      __e9 = __x299
    else
      __e9 = {__i5, hd(__x299)}
    end
...
setenv("for", {_stash = true, macro = function (i, to, ...)
  ...
  local __i7 = destash33(i, ____r63)
  local __to1 = destash33(to, ____r63)
  local ____id55 = ____r63
  local __body39 = cut(____id55, 0)
  return({"let", __i7, 0, join({"while", {"<", __i7, __to1}}, __body39, {{"inc", __i7}})})
end})
setenv("step", {_stash = true, macro = function (v, t, ...)
  ...
  local __x333 = unique("x")
  local __i9 = unique("i")
  return({"let", {__x333, __t3}, {"for", __i9, {"#", __x333}, join({"let", {__v9, {"at", __x333, __i9}}}, __body41)}})
end})
setenv("set-of", {_stash = true, macro = function (...)
  ...
  local ____o5 = __xs1
  local ____i11 = nil
  for ____i11 in next, ____o5 do
    local __x344 = ____o5[____i11]
    __l3[__x344] = true
  end
...
setenv("with-indent", {_stash = true, macro = function (form)
  local __x372 = unique("x")
  return({"do", {"inc", "indent-level"}, {"with", __x372, form, {"dec", "indent-level"}}})
end})
