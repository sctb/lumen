...
(function ()
  ...
  modules = {["lumen/main"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "reader"}, {"lumen", "compiler"}}, export = {}}, lumen = {import = {{"lumen", "special"}}, alias = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, export = {}}, ["lumen/runtime"] = {import = {{"lumen", "special"}, {"lumen", "core"}}, export = {["nil?"] = {export = true, variable = true}, ["is?"] = {export = true, variable = true}, length = {export = true, variable = true}, ["none?"] = {export = true, variable = true}, ["some?"] = {export = true, variable = true}, ["one?"] = {export = true, variable = true}, hd = {export = true, variable = true}, ["string?"] = {export = true, variable = true}, ["number?"] = {export = true, variable = true}, ["boolean?"] = {export = true, variable = true}, ["function?"] = {export = true, variable = true}, ["composite?"] = {export = true, variable = true}, ["atom?"] = {export = true, variable = true}, ["table?"] = {export = true, variable = true}, ["list?"] = {export = true, variable = true}, substring = {export = true, variable = true}, sub = {export = true, variable = true}, keys = {export = true, variable = true}, inner = {export = true, variable = true}, tl = {export = true, variable = true}, char = {export = true, variable = true}, code = {export = true, variable = true}, ["string-literal?"] = {export = true, variable = true}, ["id-literal?"] = {export = true, variable = true}, add = {export = true, variable = true}, drop = {export = true, variable = true}, last = {export = true, variable = true}, reverse = {export = true, variable = true}, join = {export = true, variable = true}, reduce = {export = true, variable = true}, keep = {export = true, variable = true}, ["in?"] = {export = true, variable = true}, find = {export = true, variable = true}, pair = {export = true, variable = true}, sort = {export = true, variable = true}, iterate = {export = true, variable = true}, replicate = {export = true, variable = true}, series = {export = true, variable = true}, map = {export = true, variable = true}, ["keys?"] = {export = true, variable = true}, ["empty?"] = {export = true, variable = true}, stash = {export = true, variable = true}, unstash = {export = true, variable = true}, search = {export = true, variable = true}, split = {export = true, variable = true}, cat = {export = true, variable = true}, ["+"] = {export = true, variable = true}, ["-"] = {export = true, variable = true}, ["*"] = {export = true, variable = true}, ["/"] = {export = true, variable = true}, ["%"] = {export = true, variable = true}, [">"] = {export = true, variable = true}, ["<"] = {export = true, variable = true}, ["="] = {export = true, variable = true}, [">="] = {export = true, variable = true}, ["<="] = {export = true, variable = true}, ["read-file"] = {export = true, variable = true}, ["write-file"] = {export = true, variable = true}, write = {export = true, variable = true}, exit = {export = true, variable = true}, today = {export = true, variable = true}, now = {export = true, variable = true}, number = {export = true, variable = true}, string = {export = true, variable = true}, space = {export = true, variable = true}, apply = {export = true, variable = true}, ["make-id"] = {export = true, variable = true}, ["%message-handler"] = {export = true, variable = true}, ["toplevel?"] = {export = true, variable = true}, ["module-key"] = {export = true, variable = true}, module = {export = true, variable = true}, setenv = {export = true, variable = true}, shift = {variable = true}, ["id-count"] = {variable = true}}}, ["lumen/compiler"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "reader"}}, export = {["compile-function"] = {export = true, variable = true}, compile = {export = true, variable = true}, ["open-module"] = {export = true, variable = true}, ["load-module"] = {export = true, variable = true}, ["in-module"] = {export = true, variable = true}, ["import-modules"] = {export = true, variable = true}, ["compile-module"] = {export = true, variable = true}, declare = {export = true, variable = true}, eval = {export = true, variable = true}, infix = {variable = true}, ["unary?"] = {variable = true}, precedence = {variable = true}, getop = {variable = true}, ["infix?"] = {variable = true}, ["compile-args"] = {variable = true}, ["compile-atom"] = {variable = true}, terminator = {variable = true}, ["compile-special"] = {variable = true}, ["parenthesize-call?"] = {variable = true}, ["compile-call"] = {variable = true}, ["op-delims"] = {variable = true}, ["compile-infix"] = {variable = true}, ["can-return?"] = {variable = true}, lower = {variable = true}, ["lower-statement"] = {variable = true}, ["lower-body"] = {variable = true}, ["lower-do"] = {variable = true}, ["lower-if"] = {variable = true}, ["lower-short"] = {variable = true}, ["lower-try"] = {variable = true}, ["lower-while"] = {variable = true}, ["lower-for"] = {variable = true}, ["lower-function"] = {variable = true}, ["lower-definition"] = {variable = true}, ["lower-call"] = {variable = true}, ["lower-infix?"] = {variable = true}, ["lower-infix"] = {variable = true}, ["lower-special"] = {variable = true}, process = {variable = true}, ["current-module"] = {global = true, export = true}, ["module-path"] = {variable = true}, encapsulate = {variable = true}, ["compile-file"] = {variable = true}, run = {variable = true}, ["compiling?"] = {variable = true}, ["compiler-output"] = {variable = true}, conclude = {variable = true}, ["%compile-module"] = {variable = true}, reimported = {variable = true}, ["%result"] = {global = true, export = true}}}, user = {import = {"lumen", {"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, export = {}}, ["lumen/reader"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}}, export = {["make-stream"] = {export = true, variable = true}, ["read-table"] = {export = true, variable = true}, ["define-reader"] = {export = true, macro = function (_g940, ...)
    ...
    return(str)
  end, stmt = true, export = true, foo = true}, ["%if"] = {tr = true, special = function (cond, cons, alt)
    local _g944 = compile(cond)
    indent_level = indent_level + 1
    local _g946 = compile(cons, {_stash = true, stmt = true})
    indent_level = indent_level - 1
    local _g945 = _g946
    local _g1042
    if alt then
      indent_level = indent_level + 1
      local _g948 = compile(alt, {_stash = true, stmt = true})
      indent_level = indent_level - 1
      _g1042 = _g948
    end
    local _g947 = _g1042
    ...
    local str = ""
    if target == "js" then
      str = str .. ind .. "if (" .. _g944 .. ") {\n" .. _g945 .. ind .. "}"
    else
      str = str .. ind .. "if " .. _g944 .. " then\n" .. _g945
    end
    if _g947 and target == "js" then
      str = str .. " else {\n" .. _g947 .. ind .. "}"
    else
      if _g947 then
        str = str .. ind .. "else\n" .. _g947
  ...
  end, stmt = true, export = true, foo = true}, ["while"] = {tr = true, special = function (cond, form)
    local _g950 = compile(cond)
    indent_level = indent_level + 1
    ...
    local ind = indentation()
    if target == "js" then
      return(ind .. "while (" .. _g950 .. ") {\n" .. body .. ind .. "}\n")
    else
      return(ind .. "while " .. _g950 .. " do\n" .. body .. ind .. "end\n")
    end
  end, stmt = true, export = true, foo = true}, ["%for"] = {tr = true, special = function (t, k, form)
    local _g953 = compile(t)
    local ind = indentation()
    indent_level = indent_level + 1
    ...
    local body = _g954
    if target == "lua" then
      return(ind .. "for " .. k .. " in next, " .. _g953 .. " do\n" .. body .. ind .. "end\n")
    else
      return(ind .. "for (" .. k .. " in " .. _g953 .. ") {\n" .. body .. ind .. "}\n")
    end
  end, stmt = true, export = true, foo = true}, ["%try"] = {tr = true, special = function (form)
    local ind = indentation()
    indent_level = indent_level + 1
    local _g956 = compile(form, {_stash = true, stmt = true})
    indent_level = indent_level - 1
    local body = _g956
    local e = make_id()
    local hf = {"return", {"%array", false, {"get", e, "\"message\""}}}
    indent_level = indent_level + 1
    local _g957 = compile(hf, {_stash = true, stmt = true})
    indent_level = indent_level - 1
    local h = _g957
    return(ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n")
  end, stmt = true, export = true, foo = true}, ["break"] = {special = function ()
  ...
  end, stmt = true, export = true, foo = true}, ["%local-function"] = {tr = true, special = function (name, args, body)
    ...
    local _g968 = compile(_g1047)
    return(indentation() .. _g967 .. " = " .. _g968)
  end, stmt = true, export = true, foo = true}, get = {special = function (t, k)
    local _g970 = compile(t)
    local k1 = compile(k)
    if target == "lua" and char(_g970, 0) == "{" then
      _g970 = "(" .. _g970 .. ")"
    end
    if string_literal63(k) and valid_id63(inner(k)) then
      return(_g970 .. "." .. inner(k))
    else
      return(_g970 .. "[" .. k1 .. "]")
    end
    ...
    local sep = _g1050
    local comma = ""
    local _g973 = pair(forms)
    local k = nil
    for k in next, _g973 do
      local v = _g973[k]
      if number63(k) then
        local _g975 = v[1]
        local _g976 = v[2]
        if not string63(_g975) then
          error("Illegal key: " .. string(_g975))
        end
        str = str .. comma .. key(_g975) .. sep .. compile(_g976)
        comma = ", "
      end
    end
    return(str .. "}")
  end, export = true, foo = true}}}, ["lumen/core"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "compiler"}}, export = {quote = {macro = function (form)
    return(quoted(form))
    ...
    local _g991 = import_modules(imp)
    local imports = _g991[1]
    local bindings = _g991[2]
    local k = module_key(spec)
    modules[k] = {import = imports, export = {}, alias = alias}
    local _g992 = exp or {}
    local _g993 = 0
    while _g993 < length(_g992) do
      local x = _g992[_g993 + 1]
    ...
    local _g995 = {"setenv", {"quote", name}}
    _g995.macro = form
    _g995.form = {"quote", form}
    eval(_g995)
    return(nil)
    ...
    local _g997 = {"setenv", {"quote", name}}
    _g997.special = form
    _g997.form = {"quote", form}
    eval(join(_g997, keys))
    return(nil)
    ...
    if some63(body) then
      ...
      return(join({"%global-function", name, args}, _g1001))
    else
      if target == "js" then
    ...
    if some63(body) and target == "js" then
      ...
      if some63(body) then
        local _g1003 = bind42(x, body)
        local args = _g1003[1]
        local _g1004 = _g1003[2]
        return(link(name, join({"%local-function", name, args}, _g1004)))
      else
  ...
  end, export = true}, ["with-bindings"] = {macro = function (_g1007, ...)
    local names = _g1007[1]
    local _g1006 = unstash({...})
    local body = sub(_g1006, 0)
    local x = make_id()
    local _g1009 = {"setenv", x}
    _g1009.variable = true
    local _g1008 = {"with-frame", {"each", {x}, names, _g1009}}
    _g1008.scope = true
    return(join(_g1008, body))
    ...
    local _g1014 = join({"do"}, macroexpand(body))
    drop(environment)
    return(_g1014)
  end, export = true}, fn = {macro = function (args, ...)
    local _g1017 = unstash({...})
    local body = sub(_g1017, 0)
    local _g1018 = bind42(args, body)
    local _g1019 = _g1018[1]
    local _g1020 = _g1018[2]
    return(join({"%function", _g1019}, _g1020))
  ...
  end, export = true}, all = {macro = function (_g1023, t, ...)
    local k = _g1023[1]
    local v = _g1023[2]
    ...
    if nil63(v) then
      ...
      local i = _g1053
      _g1052 = {"let", {i, 0}, {"while", {"<", i, {"length", t1}}, join({"let", {k, {"at", t1, i}}}, body), {"inc", i}}}
    else
      local _g1025 = {"target"}
      _g1025.js = {"isNaN", {"parseInt", k}}
      _g1025.lua = {"not", {"number?", k}}
      _g1052 = {"let", {k, "nil"}, {"%for", t1, k, {"when", _g1025, join({"let", {v, {"get", t1, k}}}, body)}}}
    end
    return({"let", {t1, t}, _g1052})
  end, export = true}, ["set-of"] = {macro = function (...)
    local xs = unstash({...})
    local l = {}
    local _g1026 = xs
    local _g1027 = 0
    while _g1027 < length(_g1026) do
      local x = _g1026[_g1027 + 1]
      l[x] = true
      _g1027 = _g1027 + 1
    end
    return(join({"table"}, l))
    ...
    local scope = _g1034.scope
    local x = make_id()
    local _g1035 = {"table"}
    _g1035._scope = scope
    return({"do", {"add", "environment", _g1035}, {"let", {x, join({"do"}, body)}, {"drop", "environment"}, x}})
  end, export = true}}}, ["lumen/system"] = {import = {{"lumen", "special"}, {"lumen", "core"}}, export = {nexus = {export = true, global = true}}}, ["lumen/boot"] = {import = {{"lumen", "runtime"}, {"lumen", "special"}, {"lumen", "core"}, {"lumen", "lib"}, {"lumen", "compiler"}}, export = {["%initial-environment"] = {macro = function ()
  ...
  environment = {{["define-module"] = {macro = function (spec, ...)
    local _g1038 = unstash({...})
    local body = sub(_g1038, 0)
    local imp = body.import
    local exp = body.export
    local alias = body.alias
    local _g1039 = import_modules(imp)
    local imports = _g1039[1]
    local bindings = _g1039[2]
    local k = module_key(spec)
    modules[k] = {import = imports, export = {}, alias = alias}
    local _g1040 = exp or {}
    local _g1041 = 0
    while _g1041 < length(_g1040) do
      local x = _g1040[_g1041 + 1]
      setenv(x, {_stash = true, export = true})
      _g1041 = _g1041 + 1
    end
    return(join({"do", {"set", {"get", "nexus", {"quote", k}}, {"table"}}}, bindings))
...
(function ()
  nexus.user = {}
  local _g1054 = nexus["lumen/runtime"]
  local nil63 = _g1054["nil?"]
  local is63 = _g1054["is?"]
  local length = _g1054.length
  local none63 = _g1054["none?"]
  local some63 = _g1054["some?"]
  local one63 = _g1054["one?"]
  local hd = _g1054.hd
  local string63 = _g1054["string?"]
  local number63 = _g1054["number?"]
  local boolean63 = _g1054["boolean?"]
  local function63 = _g1054["function?"]
  local composite63 = _g1054["composite?"]
  local atom63 = _g1054["atom?"]
  local table63 = _g1054["table?"]
  local list63 = _g1054["list?"]
  local substring = _g1054.substring
  local sub = _g1054.sub
  local keys = _g1054.keys
  local inner = _g1054.inner
  local tl = _g1054.tl
  local char = _g1054.char
  local code = _g1054.code
  local string_literal63 = _g1054["string-literal?"]
  local id_literal63 = _g1054["id-literal?"]
  local add = _g1054.add
  local drop = _g1054.drop
  local last = _g1054.last
  local reverse = _g1054.reverse
  local join = _g1054.join
  local reduce = _g1054.reduce
  local keep = _g1054.keep
  local in63 = _g1054["in?"]
  local find = _g1054.find
  local pair = _g1054.pair
  local sort = _g1054.sort
  local iterate = _g1054.iterate
  local replicate = _g1054.replicate
  local series = _g1054.series
  local map = _g1054.map
  local keys63 = _g1054["keys?"]
  local empty63 = _g1054["empty?"]
  local stash = _g1054.stash
  local unstash = _g1054.unstash
  local search = _g1054.search
  local split = _g1054.split
  local cat = _g1054.cat
  local _43 = _g1054["+"]
  local _ = _g1054["-"]
  local _42 = _g1054["*"]
  local _47 = _g1054["/"]
  ...
  local _6261 = _g1054[">="]
  local _6061 = _g1054["<="]
  local read_file = _g1054["read-file"]
  local write_file = _g1054["write-file"]
  local write = _g1054.write
  local exit = _g1054.exit
  local today = _g1054.today
  local now = _g1054.now
  local number = _g1054.number
  local string = _g1054.string
  local space = _g1054.space
  local apply = _g1054.apply
  local make_id = _g1054["make-id"]
  local _37message_handler = _g1054["%message-handler"]
  local toplevel63 = _g1054["toplevel?"]
  local module_key = _g1054["module-key"]
  local module = _g1054.module
  local setenv = _g1054.setenv
end)();
(function ()
  nexus["lumen/main"] = {}
  ...
  local function rep(str)
    local _g1059,_g1060 = xpcall(function ()
      return(eval(read_from_string(str)))
    end, _37message_handler)
    local _g1058 = {_g1059, _g1060}
    local _g1 = _g1058[1]
    local x = _g1058[2]
    if is63(x) then
