...
(deftest map ()
  (test-equal '(1) (map (fn (x) x) '(1)))
  (test-equal '(2 3 4) (map (fn (x) (+ x 1)) '(1 2 3))))
...
(deftest reduce ()
  (test-equal 6 (reduce (fn (a b) (+ a b)) '(1 2 3)))
  (test-equal '(1 (2 3))
	      (reduce
	       (fn (a b) (list a b))
	       '(1 2 3)))
...
(deftest type ()
  ...
  (test-equal true (function? (fn () 17)))
...
(deftest apply ()
  (test-equal 4 (apply (fn (a b) (+ a b)) '(2 2)))
  (test-equal '(2 2) (apply (fn (a...) a) '(2 2))))
