...
var body1 = compile(body,true,is_tail);
var tr = (function () {
...
var body1 = compile_body(body,true);
if ((target=="js")) {
...
var body = compile_body(sub(form,1));
if ((target=="js")) {
...
var t1 = compile(t);
if ((target=="lua")) {
var body1 = compile_body(body);
return(("for "+k+","+v+" in pairs("+t1+") do\n"+body1+"end\n"));
} else {
var _50 = compile_body(join([["set!", v, ["get", t, k]]],body));
return(("for ("+k+" in "+t1+") {\n"+_50+"}\n"));
}
}, statement : true, terminated : true};
