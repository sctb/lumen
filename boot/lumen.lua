...
compile_toplevel = function (form)
  local _g132 = compile(macroexpand(form), {_stash = true, ["stmt?"] = true})
  if (_g132 == "") then
    return("")
  else
    return((_g132 .. "\n"))
...
setenv("define-reader", {macro = function (_g94, ...)
  local char = _g94[1]
  local stream = _g94[2]
  local body = unstash({...})
