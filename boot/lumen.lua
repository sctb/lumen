...
infix = {common = {["*"] = true, ["+"] = true, ["<"] = true, ["-"] = true, [">"] = true, ["<="] = true, [">="] = true, ["/"] = true, ["%"] = true}, lua = {["~="] = true, ["="] = "==", ["or"] = true, ["and"] = true, ["cat"] = ".."}, js = {["~="] = "!=", ["="] = "===", ["or"] = "||", ["and"] = "&&", ["cat"] = "+"}}
function getop(op)
...
function bind_arguments(args, body)
  ...
  if atom63(args) then
    ...
    local _g128 = 0
    local _g127 = args
    while (_g128 < length(_g127)) do
      local arg = _g127[(_g128 + 1)]
      if atom63(arg) then
        add(args1, arg)
...
function macroexpand(form)
  ...
  elseif atom63(form) then
    ...
    elseif (x == "%function") then
      local _g3 = form[1]
      local args = form[2]
      local _g132 = sub(form, 2)
      add(environment, {})
      local _g134 = (function ()
        local _g136 = 0
        local _g135 = args
        while (_g136 < length(_g135)) do
          local _g133 = _g135[(_g136 + 1)]
    ...
    elseif ((x == "%local-function") or (x == "%global-function")) then
      ...
      local name = form[2]
      local _g137 = form[3]
      local _g138 = sub(form, 3)
      add(environment, {})
      local _g140 = (function ()
        local _g142 = 0
        local _g141 = _g137
        while (_g142 < length(_g141)) do
          local _g139 = _g141[(_g142 + 1)]
...
function sub(x, from, upto)
  ...
  if string63(x) then
    return((string.sub)(x, (_g146 + 1), upto))
  else
    local l = (function ()
      local i = _g146
      local j = 0
...
function rep(str)
  local _g179 = (function ()
    local _g180,_g181 = xpcall(function ()
...
setenv("define-global", {macro = function (name, x, ...)
  ...
  if (not empty63(_g183)) then
    local _g184 = bind_arguments(x, _g183)
    local args = _g184[1]
    local _g185 = _g184[2]
...
setenv("fn", {macro = function (args, ...)
  ...
  local _g187 = bind_arguments(args, _g186)
  local args = _g187[1]
  local _g188 = _g187[2]
  return(join({"%function", args}, _g188))
end})
...
setenv("%for", {tr = true, stmt = true, special = function (_g192)
  local _g193 = _g192[1]
  local t = _g193[1]
  local k = _g193[2]
...
setenv("%global-function", {tr = true, stmt = true, special = function (_g199)
  local name = _g199[1]
  local args = _g199[2]
...
setenv("%local-function", {tr = true, stmt = true, special = function (_g212)
  local name = _g212[1]
  local args = _g212[2]
  local body = sub(_g212, 2)
  return(compile_function(args, body, {_stash = true, prefix = "local ", name = name}))
end})
setenv("%local", {special = function (_g213)
  local name = _g213[1]
  local value = _g213[2]
...
setenv("define-reader", {macro = function (_g215, ...)
  local char = _g215[1]
  local stream = _g215[2]
  local body = unstash({...})
  local _g216 = sub(body, 0)
  return({"set", {"get", "read-table", char}, join({"fn", {stream}}, _g216)})
end})
setenv("while", {tr = true, stmt = true, special = function (_g217)
  local condition = _g217[1]
  local body = sub(_g217, 1)
  local condition = compile(condition)
  local body = (function ()
    indent_level = (indent_level + 1)
    local _g218 = compile_body(body)
    indent_level = (indent_level - 1)
    return(_g218)
  end)()
  local ind = indentation()
...
setenv("error", {special = function (_g219)
  local x = _g219[1]
  local e = (function ()
    if (target == "js") then
...
setenv("with-bindings", {macro = function (_g221, ...)
  local names = _g221[1]
  local body = unstash({...})
...
setenv("set", {special = function (_g229)
  local lh = _g229[1]
  local rh = _g229[2]
  if nil63(rh) then
...
setenv("define-macro", {macro = function (name, args, ...)
  ...
  local form = join({"fn", args}, _g233)
  local value = (function ()
    local _g234 = {"table"}
    _g234.macro = form
    _g234.form = {"quote", form}
    return(_g234)
  end)()
  local binding = {"setenv", {"quote", name}, value}
  eval(binding)
...
setenv("across", {macro = function (_g236, ...)
  local l = _g236[1]
  local v = _g236[2]
  local i = _g236[3]
  local start = _g236[4]
...
setenv("let", {macro = function (bindings, ...)
  ...
  map(function (_g239)
    ...
    local rh = _g239[2]
    local _g241 = 0
    local _g240 = bind(lh, rh)
    while (_g241 < length(_g240)) do
      local _g242 = _g240[(_g241 + 1)]
      local id = _g242[1]
      local val = _g242[2]
      if bound63(id) then
...
setenv("get", {special = function (_g243)
  local t = _g243[1]
  local k = _g243[2]
  local t = compile(t)
  local k1 = compile(k)
