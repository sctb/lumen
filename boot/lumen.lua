...
(function ()
  ...
  local reserved = {["switch"] = true, ["then"] = true, ["repeat"] = true, ["false"] = true, ["if"] = true, ["+"] = true, ["end"] = true, ["and"] = true, ["for"] = true, ["elseif"] = true, [">"] = true, ["delete"] = true, ["while"] = true, ["instanceof"] = true, ["in"] = true, ["until"] = true, ["function"] = true, ["else"] = true, ["try"] = true, ["true"] = true, ["local"] = true, ["or"] = true, ["continue"] = true, ["return"] = true, ["="] = true, ["*"] = true, [">="] = true, ["-"] = true, ["nil"] = true, ["not"] = true, ["debugger"] = true, ["with"] = true, ["finally"] = true, ["catch"] = true, ["=="] = true, ["default"] = true, ["case"] = true, ["void"] = true, ["new"] = true, ["<="] = true, ["/"] = true, ["throw"] = true, ["<"] = true, ["this"] = true, ["typeof"] = true, ["break"] = true, ["%"] = true, ["do"] = true, ["var"] = true}
...
(function ()
  ...
  local infix = {common = {["<="] = true, ["*"] = true, ["%"] = true, ["/"] = true, ["+"] = true, ["-"] = true, [">"] = true, [">="] = true, ["<"] = true}, js = {["~="] = "!=", ["="] = "===", cat = "+", ["and"] = "&&", ["or"] = "||"}, lua = {["and"] = true, ["="] = "==", cat = "..", ["~="] = true, ["or"] = true}}
...
(function ()
  ...
  local compile_special = _g156["compile-special"]
  local compile = _g156.compile
  local compile_call = _g156["compile-call"]
...
(function ()
  ...
  local compile_special = _g366["compile-special"]
  local compile = _g366.compile
  local compile_call = _g366["compile-call"]
...
(function ()
  ...
  local compile_special = _g648["compile-special"]
  local compile = _g648.compile
  local compile_call = _g648["compile-call"]
  ...
  modules = {runtime = {export = {write = {export = true, variable = true}, ["string-literal?"] = {export = true, variable = true}, char = {export = true, variable = true}, ["%message-handler"] = {export = true, variable = true}, reverse = {export = true, variable = true}, ["table?"] = {export = true, variable = true}, ["read-file"] = {export = true, variable = true}, ["boolean?"] = {export = true, variable = true}, split = {export = true, variable = true}, keep = {export = true, variable = true}, join = {export = true, variable = true}, length = {export = true, variable = true}, splice = {export = true, variable = true}, ["string?"] = {export = true, variable = true}, module = {export = true, variable = true}, extend = {export = true, variable = true}, pairwise = {export = true, variable = true}, drop = {export = true, variable = true}, substring = {export = true, variable = true}, sub = {export = true, variable = true}, ["number?"] = {export = true, variable = true}, ["none?"] = {export = true, variable = true}, ["id-count"] = {variable = true}, ["composite?"] = {export = true, variable = true}, ["write-file"] = {export = true, variable = true}, unstash = {export = true, variable = true}, sublist = {export = true, variable = true}, exclude = {export = true, variable = true}, mapl = {variable = true}, ["keys?"] = {export = true, variable = true}, reduce = {export = true, variable = true}, [">="] = {export = true, variable = true}, ["nil?"] = {export = true, variable = true}, code = {export = true, variable = true}, ["splice?"] = {variable = true}, setenv = {export = true, variable = true}, ["module-key"] = {export = true, variable = true}, ["toplevel?"] = {export = true, variable = true}, apply = {export = true, variable = true}, inner = {export = true, variable = true}, ["empty?"] = {export = true, variable = true}, last = {export = true, variable = true}, ["is?"] = {export = true, variable = true}, cat = {export = true, variable = true}, ["atom?"] = {export = true, variable = true}, ["to-string"] = {export = true, variable = true}, ["make-id"] = {export = true, variable = true}, stash = {export = true, variable = true}, hd = {export = true, variable = true}, ["parse-number"] = {export = true, variable = true}, exit = {export = true, variable = true}, iterate = {export = true, variable = true}, replicate = {export = true, variable = true}, search = {export = true, variable = true}, ["some?"] = {export = true, variable = true}, map = {export = true, variable = true}, ["*"] = {export = true, variable = true}, add = {export = true, variable = true}, ["id-literal?"] = {export = true, variable = true}, ["%"] = {export = true, variable = true}, tl = {export = true, variable = true}, find = {export = true, variable = true}, ["<="] = {export = true, variable = true}, ["="] = {export = true, variable = true}, ["function?"] = {export = true, variable = true}, ["/"] = {export = true, variable = true}, ["<"] = {export = true, variable = true}, ["-"] = {export = true, variable = true}, [">"] = {export = true, variable = true}, ["+"] = {export = true, variable = true}, ["list?"] = {export = true, variable = true}}, import = {"special", "core"}}, optimizer = {export = {optimizations = {variable = true}, optimize = {variable = true, export = true}, ["define-optimization"] = {}}, import = {"runtime", "special", "core"}}, lib = {export = {}, import = {"core", "special"}}, utilities = {export = {["macro-function"] = {export = true, variable = true}, ["with-indent"] = {export = true, macro = function (form)
    local result = make_id()
    return({"do", {"inc", "indent-level"}, {"let", {result, form}, {"dec", "indent-level"}, result}})
  end}, ["special?"] = {export = true, variable = true}, ["quasiquoting?"] = {variable = true}, exported = {export = true, variable = true}, ["macro?"] = {export = true, variable = true}, ["valid-id?"] = {export = true, variable = true}, ["initial-environment"] = {export = true, variable = true}, mapo = {export = true, variable = true}, macroexpand = {export = true, variable = true}, ["quote-frame"] = {variable = true}, ["statement?"] = {export = true, variable = true}, quoted = {export = true, variable = true}, ["quasiquote-list"] = {variable = true}, reserved = {variable = true}, indentation = {export = true, variable = true}, ["special-form?"] = {export = true, variable = true}, quasiexpand = {export = true, variable = true}, escape = {variable = true}, getenv = {export = true, variable = true}, ["quote-environment"] = {export = true, variable = true}, ["indent-level"] = {global = true, export = true}, ["quote-modules"] = {export = true, variable = true}, ["bind*"] = {export = true, variable = true}, ["quote-module"] = {variable = true}, ["variable?"] = {export = true, variable = true}, ["quote-binding"] = {variable = true}, imported = {export = true, variable = true}, bind = {export = true, variable = true}, ["numeric?"] = {variable = true}, ["valid-char?"] = {variable = true}, ["toplevel?"] = {export = true, variable = true}, ["can-unquote?"] = {variable = true}, ["quoting?"] = {variable = true}, ["symbol-expansion"] = {export = true, variable = true}, ["symbol?"] = {export = true, variable = true}, ["bound?"] = {export = true, variable = true}, ["global?"] = {variable = true}, ["to-id"] = {export = true, variable = true}, ["reserved?"] = {export = true, variable = true}, ["stash*"] = {export = true, variable = true}, ["quasisplice?"] = {variable = true}}, import = {"runtime", "special", "core"}}, system = {export = {nexus = {global = true, export = true}}, import = {"special", "core"}}, reader = {export = {eof = {variable = true}, ["skip-non-code"] = {variable = true}, ["make-stream"] = {export = true, variable = true}, ["flag?"] = {variable = true}, delimiters = {variable = true}, ["key?"] = {variable = true}, ["read-char"] = {variable = true}, ["read-from-string"] = {export = true, variable = true}, ["read-table"] = {export = true, variable = true}, read = {export = true, variable = true}, ["define-reader"] = {export = true, macro = function (_g661, ...)
    local char = _g661[1]
    local stream = _g661[2]
    local body = unstash({...})
    local _g662 = sub(body, 0)
    return({"set", {"get", "read-table", char}, join({"fn", {stream}}, _g662)})
  end}, ["peek-char"] = {variable = true}, ["read-all"] = {export = true, variable = true}, whitespace = {variable = true}}, import = {"runtime", "special", "core"}}, main = {export = {save = {macro = function (...)
    local specs = unstash({...})
    local _g663 = sub(specs, 0)
    map(compile_module, _g663)
    return(nil)
  end}}, import = {"runtime", "special", "core", "reader", "compiler"}}, special = {export = {["%for"] = {export = true, tr = true, stmt = true, special = function (_g664)
    local t = _g664[1]
    local k = _g664[2]
    local form = _g664[3]
    local _g665 = compile(t)
    local ind = indentation()
    indent_level = (indent_level + 1)
    local _g666 = compile(form, {_stash = true, stmt = true})
    indent_level = (indent_level - 1)
    local body = _g666
    if (target == "lua") then
      return((ind .. "for " .. k .. " in next, " .. _g665 .. " do\n" .. body .. ind .. "end\n"))
    else
      return((ind .. "for (" .. k .. " in " .. _g665 .. ") {\n" .. body .. ind .. "}\n"))
    end
  ...
  end}, ["return"] = {export = true, stmt = true, special = function (_g668)
    local x = _g668[1]
    local _g747
    if nil63(x) then
      _g747 = "return"
    else
      _g747 = compile_call({"return", x})
    end
    local _g669 = _g747
    return((indentation() .. _g669))
  end}, ["%if"] = {export = true, tr = true, stmt = true, special = function (_g670, tail63)
    local cond = _g670[1]
    local _g671 = _g670[2]
    local _g672 = _g670[3]
    local _g673 = compile(cond)
    indent_level = (indent_level + 1)
    local _g676 = compile(_g671, {_stash = true, tail = tail63, stmt = true})
    indent_level = (indent_level - 1)
    local _g674 = _g676
    local _g748
    if _g672 then
      indent_level = (indent_level + 1)
      local _g677 = compile(_g672, {_stash = true, tail = tail63, stmt = true})
      indent_level = (indent_level - 1)
      _g748 = _g677
    end
    local _g675 = _g748
  ...
  end}, ["get"] = {export = true, special = function (_g678)
    local t = _g678[1]
    local k = _g678[2]
    local _g679 = compile(t)
    local k1 = compile(k)
    if ((target == "lua") and (char(_g679, 0) == "{")) then
      _g679 = ("(" .. _g679 .. ")")
    end
    if (string_literal63(k) and valid_id63(inner(k))) then
      return((_g679 .. "." .. inner(k)))
    else
      return((_g679 .. "[" .. k1 .. "]"))
    end
  end}, ["%local-function"] = {export = true, tr = true, stmt = true, special = function (_g680)
    local name = _g680[1]
    local args = _g680[2]
    local body = _g680[3]
    ...
    while (i < length(_g681)) do
      local _g682 = _g681[(i + 1)]
      local k = _g682[1]
      local v = _g682[2]
      if (not string63(k)) then
        error(("Illegal key: " .. to_string(k)))
      end
      local _g683 = compile(v)
      local _g750
    ...
    return((str .. "}"))
  end}, ["%try"] = {export = true, tr = true, stmt = true, special = function (_g685)
    local form = _g685[1]
    local ind = indentation()
    indent_level = (indent_level + 1)
    local _g686 = compile(form, {_stash = true, tail = true, stmt = true})
    indent_level = (indent_level - 1)
    local body = _g686
    local e = make_id()
    ...
    local h = _g687
    return((ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n"))
  end}, ["error"] = {export = true, stmt = true, special = function (_g688)
    local x = _g688[1]
    local _g754
    if (target == "js") then
      _g754 = ("throw new " .. compile({"Error", x}))
    else
      _g754 = compile_call({"error", x})
    end
    local e = _g754
    return((indentation() .. e))
  end}, ["%function"] = {export = true, special = function (_g689)
    local args = _g689[1]
    local body = _g689[2]
    return(compile_function(args, body))
  end}, ["do"] = {export = true, tr = true, stmt = true, special = function (forms, tail63)
    local str = ""
    local _g690 = forms
    local i = 0
    ...
    return(str)
  end}, ["while"] = {export = true, tr = true, stmt = true, special = function (_g691)
    local condition = _g691[1]
    local form = _g691[2]
    local _g692 = compile(condition)
    indent_level = (indent_level + 1)
    local _g693 = compile(form, {_stash = true, stmt = true})
    indent_level = (indent_level - 1)
    local body = _g693
    local ind = indentation()
    if (target == "js") then
  ...
  end}, ["not"] = {export = true, special = function (_g694)
    local x = _g694[1]
    local _g695 = compile(x)
    local _g755
    if (target == "js") then
      _g755 = "!("
    else
    ...
    local open = _g755
    return((open .. _g695 .. ")"))
  end}, ["%global-function"] = {export = true, tr = true, stmt = true, special = function (_g696)
    local name = _g696[1]
    local args = _g696[2]
    local body = _g696[3]
    if (target == "lua") then
  ...
  end}, ["set"] = {export = true, stmt = true, special = function (_g697)
    local lh = _g697[1]
    local rh = _g697[2]
    local _g698 = compile(lh)
    local _g756
    if nil63(rh) then
      _g756 = "nil"
    else
    ...
    local _g699 = compile(_g756)
    return((indentation() .. _g698 .. " = " .. _g699))
  end}, ["%local"] = {export = true, stmt = true, special = function (_g700)
    local name = _g700[1]
    local value = _g700[2]
  ...
  end}}, import = {"runtime", "utilities", "special", "core", "compiler"}}, boot = {export = {["%initial-environment"] = {macro = function ()
    return(quote_environment(initial_environment()))
  end}, modules = {global = true, export = true}, ["%initial-modules"] = {macro = function ()
    return(quote_modules())
  end}}, import = {"runtime", "utilities", "special", "core", "compiler"}}, compiler = {export = {["lower-do"] = {variable = true}, ["lower-if"] = {variable = true}, terminator = {variable = true}, ["can-return?"] = {variable = true}, run = {variable = true}, ["compile-module"] = {export = true, variable = true}, ["load-module"] = {export = true, variable = true}, ["in-module"] = {export = true, variable = true}, ["compile-atom"] = {variable = true}, process = {variable = true}, ["compile-special"] = {export = true, variable = true}, ["lower-call"] = {variable = true}, getop = {variable = true}, ["lower-statement"] = {variable = true}, ["compiler-output"] = {variable = true}, encapsulate = {variable = true}, prologue = {variable = true}, ["%compile-module"] = {variable = true}, compile = {export = true, variable = true}, ["lower-for"] = {variable = true}, ["compile-infix"] = {variable = true}, ["compile-call"] = {export = true, variable = true}, ["lower-while"] = {variable = true}, ["open-module"] = {export = true, variable = true}, ["module-path"] = {variable = true}, ["compile-function"] = {export = true, variable = true}, ["%result"] = {global = true, export = true}, ["compile-file"] = {variable = true}, infix = {variable = true}, ["lower-definition"] = {variable = true}, ["lower-function"] = {variable = true}, ["compile-args"] = {variable = true}, lower = {export = true, global = true, variable = true}, eval = {export = true, variable = true}, ["infix?"] = {variable = true}, ["current-module"] = {global = true, export = true}, ["lower-special"] = {variable = true}, ["compiling?"] = {variable = true}}, import = {"runtime", "utilities", "special", "core", "reader"}}, core = {export = {["define-special"] = {export = true, macro = function (name, args, ...)
    local body = unstash({...})
    local _g701 = sub(body, 0)
    local form = join({"fn", args}, _g701)
    local keys = sub(_g701, length(_g701))
    local _g702 = {"setenv", {"quote", name}}
    _g702.form = {"quote", form}
    _g702.special = form
    eval(join(_g702, keys))
    return(nil)
    ...
    if some63(_g707) then
      ...
      local args = _g708[1]
      local _g709 = _g708[2]
      return(join({"%local-function", name, args}, _g709))
    else
      return({"%local", name, x})
    end
  end}, ["define*"] = {export = true, macro = function (name, x, ...)
    ...
    local _g715 = {"table"}
    _g715._scope = scope
    return({"do", {"add", "environment", _g715}, {"let", {x, join({"do"}, _g714)}, {"drop", "environment"}, x}})
  end}, pr = {export = true, macro = function (...)
    local xs = unstash({...})
    local _g716 = map(function (x)
      return(splice({{"to-string", x}, "\" \""}))
    end, xs)
    return({"print", join({"cat"}, _g716)})
    ...
    if nil63(v) then
      ...
      local i = _g760
      _g759 = {"let", {i, 0}, {"while", {"<", i, {"length", t1}}, join({"let", {k, {"at", t1, i}}}, _g717), {"inc", i}}}
    else
      local _g718 = {"target"}
      _g718.lua = {"not", {"number?", k}}
      _g718.js = {"isNaN", {"parseInt", k}}
      _g759 = {"let", {k, "nil"}, {"%for", t1, k, {"if", _g718, join({"let", {v, {"get", t1, k}}}, _g717)}}}
    end
    ...
    local imports = {}
    local exp = _g722.export
    local imp = _g722.import
    local _g723 = (imp or {})
    local _g724 = 0
    ...
    local _g728 = join({"do"}, macroexpand(_g727))
    drop(environment)
    return(_g728)
  end}, ["join!"] = {export = true, macro = function (a, ...)
    local bs = unstash({...})
    local _g730 = sub(bs, 0)
    return({"set", a, join({"join*", a}, _g730)})
  end}, ["with-bindings"] = {export = true, macro = function (_g731, ...)
    local names = _g731[1]
    local body = unstash({...})
    local _g732 = sub(body, 0)
    local x = make_id()
    local _g734 = {"setenv", x}
    _g734.variable = true
    local _g733 = {"with-frame", {"each", {x}, names, _g734}}
    _g733.scope = true
    return(join(_g733, _g732))
    ...
    local l = {}
    local _g735 = elements
    local _g736 = 0
    while (_g736 < length(_g735)) do
      local e = _g735[(_g736 + 1)]
      l[e] = true
      _g736 = (_g736 + 1)
    end
    return(join({"table"}, l))
    ...
    map(function (_g738)
      local lh = _g738[1]
      local rh = _g738[2]
      local _g739 = bind(lh, rh)
      local _g740 = 0
      while (_g740 < length(_g739)) do
        local _g741 = _g739[(_g740 + 1)]
        local id = _g741[1]
        local val = _g741[2]
    ...
    return(join({"do"}, join(locals, {join({"let-symbol", renames}, _g737)})))
    ...
    local _g743 = join({"do"}, macroexpand(_g742))
    drop(environment)
    return(_g743)
    ...
    return(quoted(form))
  end}}, import = {"runtime", "utilities", "special", "core", "compiler"}}}
