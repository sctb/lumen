(function ()
  ...
  local reserved = {["do"] = true, ["nil"] = true, ["new"] = true, [">="] = true, ["or"] = true, ["continue"] = true, ["true"] = true, ["break"] = true, ["instanceof"] = true, ["else"] = true, ["case"] = true, ["<"] = true, ["default"] = true, ["this"] = true, ["while"] = true, ["void"] = true, ["function"] = true, ["return"] = true, ["then"] = true, ["typeof"] = true, ["debugger"] = true, ["=="] = true, ["-"] = true, ["local"] = true, ["+"] = true, ["if"] = true, ["until"] = true, ["for"] = true, ["%"] = true, ["*"] = true, ["throw"] = true, ["false"] = true, ["finally"] = true, ["/"] = true, ["="] = true, ["end"] = true, ["<="] = true, ["with"] = true, ["and"] = true, ["switch"] = true, [">"] = true, ["try"] = true, ["catch"] = true, ["repeat"] = true, ["delete"] = true, ["elseif"] = true, ["in"] = true, ["not"] = true, ["var"] = true}
...
(function ()
  ...
  local infix = {common = {["-"] = true, ["<"] = true, ["+"] = true, ["<="] = true, ["/"] = true, [">"] = true, ["%"] = true, ["*"] = true, [">="] = true}, js = {["="] = "===", ["~="] = "!=", cat = "+", ["or"] = "||", ["and"] = "&&"}, lua = {["and"] = true, ["~="] = true, cat = "..", ["or"] = true, ["="] = "=="}}
...
(function ()
  ...
  modules = {special = {import = {"utilities", "special", "core", "compiler"}, export = {["%for"] = {special = function (_g243)
    local _g244 = _g243[1]
    local t = _g244[1]
    local k = _g244[2]
    local body = sub(_g243, 1)
    local _g245 = compile(t)
    local ind = indentation()
    local _g246 = (function ()
      indent_level = (indent_level + 1)
      local _g247 = compile_body(body)
      indent_level = (indent_level - 1)
      return(_g247)
    end)()
    if (target == "lua") then
      return((ind .. "for " .. k .. " in next, " .. _g245 .. " do\n" .. _g246 .. ind .. "end\n"))
    else
      return((ind .. "for (" .. k .. " in " .. _g245 .. ") {\n" .. _g246 .. ind .. "}\n"))
    end
  end, tr = true, module = "special", stmt = true, export = true}, ["while"] = {special = function (_g248)
    local condition = _g248[1]
    local body = sub(_g248, 1)
    local _g249 = compile(condition)
    ...
    local ind = indentation()
    if (target == "js") then
      return((ind .. "while (" .. _g249 .. ") {\n" .. _g250 .. ind .. "}\n"))
    else
      return((ind .. "while " .. _g249 .. " do\n" .. _g250 .. ind .. "end\n"))
    end
  end, tr = true, module = "special", stmt = true, export = true}, ["return"] = {special = function (_g252)
    local x = _g252[1]
  ...
  end, stmt = true, module = "special", export = true}, ["if"] = {special = function (form, tail63)
    local str = ""
    local i = 0
    local _g254 = form
    while (i < length(_g254)) do
      local condition = _g254[(i + 1)]
    ...
    return(str)
  end, tr = true, module = "special", stmt = true, export = true}, ["%local-function"] = {special = function (_g255)
    local name = _g255[1]
    local args = _g255[2]
    local body = sub(_g255, 2)
    local x = compile_function(args, body, {_stash = true, name = name, prefix = "local "})
    return((indentation() .. x))
  end, tr = true, module = "special", stmt = true, export = true}, ["%function"] = {module = "special", special = function (_g256)
    local args = _g256[1]
    local body = sub(_g256, 1)
    return(compile_function(args, body))
  end, export = true}, ["set"] = {special = function (_g257)
    local lh = _g257[1]
    local rh = _g257[2]
    if nil63(rh) then
  ...
  end, stmt = true, module = "special", export = true}, ["error"] = {special = function (_g258)
    local x = _g258[1]
    local e = (function ()
      if (target == "js") then
  ...
  end, stmt = true, module = "special", export = true}, ["break"] = {special = function (_g110)
    return((indentation() .. "break"))
  end, stmt = true, module = "special", export = true}, ["%try"] = {special = function (forms)
    local ind = indentation()
    local body = (function ()
      indent_level = (indent_level + 1)
      local _g259 = compile_body(forms, {_stash = true, ["tail?"] = true})
      indent_level = (indent_level - 1)
      return(_g259)
    end)()
    local e = make_id()
    ...
    local h = (function ()
      indent_level = (indent_level + 1)
      local _g260 = compile(handler, {_stash = true, ["stmt?"] = true})
      indent_level = (indent_level - 1)
      return(_g260)
    end)()
    return((ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n"))
  end, tr = true, module = "special", stmt = true, export = true}, ["%object"] = {module = "special", special = function (forms)
    local str = "{"
    local sep = (function ()
      if (target == "lua") then
        return(" = ")
    ...
    return((str .. "}"))
  end, export = true}, ["%local"] = {special = function (_g265)
    local name = _g265[1]
    local value = _g265[2]
    local id = compile(name)
    local _g266 = compile(value)
    ...
    local ind = indentation()
    return((ind .. keyword .. id .. " = " .. _g266))
  end, stmt = true, module = "special", export = true}, ["%global-function"] = {special = function (_g267)
    local name = _g267[1]
    local args = _g267[2]
    local body = sub(_g267, 2)
    if (target == "lua") then
  ...
  end, tr = true, module = "special", stmt = true, export = true}, ["do"] = {special = function (forms, tail63)
    return(compile_body(forms, {_stash = true, ["tail?"] = tail63}))
  end, tr = true, module = "special", stmt = true, export = true}, ["not"] = {module = "special", special = function (_g268)
    local x = _g268[1]
    local _g269 = compile(x)
    local open = (function ()
      if (target == "js") then
        return("!(")
      else
    ...
    return((open .. _g269 .. ")"))
  end, export = true}, ["get"] = {module = "special", special = function (_g270)
    local t = _g270[1]
    local k = _g270[2]
    local _g271 = compile(t)
    local k1 = compile(k)
    if ((target == "lua") and (char(_g271, 0) == "{")) then
      _g271 = ("(" .. _g271 .. ")")
    end
    if (string_literal63(k) and valid_id63(inner(k))) then
      return((_g271 .. "." .. inner(k)))
    else
      return((_g271 .. "[" .. k1 .. "]"))
    end
  ...
  end, export = true}}}, core = {import = {"utilities", "runtime", "special", "core"}, export = {["define-local"] = {module = "core", export = true, macro = function (name, x, ...)
    local body = unstash({...})
    local _g273 = sub(body, 0)
    setenv(name, {_stash = true, variable = true})
    if (not empty63(_g273)) then
      local _g274 = bind42(x, _g273)
      local args = _g274[1]
      local _g275 = _g274[2]
    ...
    local l = {}
    local _g280 = 0
    local _g279 = elements
    while (_g280 < length(_g279)) do
      local e = _g279[(_g280 + 1)]
      l[e] = true
      _g280 = (_g280 + 1)
    end
    return(join({"table"}, l))
  ...
  end}, ["with-bindings"] = {module = "core", export = true, macro = function (_g281, ...)
    local names = _g281[1]
    local body = unstash({...})
    local _g282 = sub(body, 0)
    local x = make_id()
    return(join((function ()
      local _g283 = {"with-frame", join({"across", join({names, x}), join((function ()
        local _g284 = {"setenv", x}
        _g284.variable = true
        return(_g284)
      end)())})}
      _g283.scope = true
    ...
    map(function (_g286)
      ...
      local rh = _g286[2]
      local _g288 = 0
      local _g287 = bind(lh, rh)
      while (_g288 < length(_g287)) do
        local _g289 = _g287[(_g288 + 1)]
        local id = _g289[1]
        local val = _g289[2]
        if bound63(id) then
    ...
    return(join({"do"}, join(locals, {join({"let-symbol", renames}, _g285)})))
    ...
    return(join({"get", l, i}))
  end}, each = {module = "core", export = true, macro = function (_g290, ...)
    local t = _g290[1]
    local k = _g290[2]
    local v = _g290[3]
    local body = unstash({...})
    ...
    return(join({"let", join({k, "nil", t1, t}), join({"%for", join({t1, k}), join({"if", join((function ()
      local _g292 = {"target"}
      _g292.lua = join({"not", join({"number?", k})})
      _g292.js = join({"isNaN", join({"parseInt", k})})
      return(_g292)
    end)()), join({"let", join({v, join({"get", t1, k})})}, _g291)})})}))
    ...
    local _g297 = bind42(args, _g296)
    local _g298 = _g297[1]
    local _g299 = _g297[2]
    return(join({"%function", _g298}, _g299))
  end}, pr = {module = "core", export = true, macro = function (...)
    local xs = unstash({...})
    local _g300 = map(function (x)
      return(splice(join({join({"to-string", x}), "\" \""})))
    end, xs)
    return(join({"print", join({"cat"}, _g300)}))
  end}, ["cat!"] = {module = "core", export = true, macro = function (a, ...)
    local bs = unstash({...})
    local _g301 = sub(bs, 0)
    return(join({"set", a, join({"cat", a}, _g301)}))
    ...
    local _g303 = (function ()
      ...
      return(join({"do"}, macroexpand(_g302)))
    end)()
    drop(environment)
    return(_g303)
    ...
    return(join({"do", join({"add", "environment", join((function ()
      ...
      _g305._scope = scope
      return(_g305)
    end)())}), join({"let", join({x, join({"do"}, _g304)}), join({"drop", "environment"}), x})}))
  end}, across = {module = "core", export = true, macro = function (_g306, ...)
    local l = _g306[1]
    local v = _g306[2]
    local i = _g306[3]
    local start = _g306[4]
    ...
    i = (i or make_id())
    start = (start or 0)
    return(join({"let", join({i, start, l1, l}), join({"while", join({"<", i, join({"length", l1})}), join({"let", join({v, join({"at", l1, i})})}, join(_g307, {join({"inc", i})}))})}))
  ...
  end}, target = {module = "core", export = true, global = true, macro = function (...)
    ...
    local bs = unstash({...})
    local _g309 = sub(bs, 0)
    return(join({"set", a, join({"join*", a}, _g309)}))
    ...
    local form = join({"fn", args}, _g310)
    eval(join((function ()
      local _g311 = {"setenv", join({"quote", name})}
      _g311.form = join({"quote", form})
      _g311.macro = form
      return(_g311)
    end)()))
    return(nil)
    ...
    local _g313 = (function ()
      ...
      return(join({"do"}, macroexpand(_g312)))
    end)()
    drop(environment)
    return(_g313)
    ...
    if (not empty63(_g315)) then
      local _g316 = bind42(x, _g315)
      local args = _g316[1]
      local _g317 = _g316[2]
      return(join({"%global-function", name, args}, _g317))
    elseif (target == "js") then
      return(join({"set", join({"get", "global", join({"quote", to_id(name)})}), x}))
    else
      return(join({"set", name, x}))
    end
  end}}}, boot = {import = {"utilities", "special", "core"}, export = {}}, compiler = {import = {"utilities", "runtime", "special", "core", "reader"}, export = {["compile-special"] = {module = "compiler", variable = true, export = true}, ["compile-call"] = {module = "compiler", variable = true, export = true}, ["compile-body"] = {module = "compiler", variable = true, export = true}, ["in-module"] = {module = "compiler", variable = true, export = true}, ["define-module"] = {module = "compiler", export = true, macro = function (spec, ...)
    local body = unstash({...})
    local _g318 = sub(body, 0)
    local imports = {}
    local imp = _g318.import
    local exp = _g318.export
    local _g320 = 0
    local _g319 = (imp or {})
    while (_g320 < length(_g319)) do
      local k = _g319[(_g320 + 1)]
      load_module(k)
    ...
    return(join({"do"}, imports))
  end}, ["open-module"] = {module = "compiler", variable = true, export = true}, compile = {module = "compiler", variable = true, export = true}, ["compile-branch"] = {module = "compiler", variable = true, export = true}, ["compile-function"] = {module = "compiler", variable = true, export = true}, ["%result"] = {module = "compiler", global = true, export = true}, ["load-module"] = {module = "compiler", variable = true, export = true}, eval = {module = "compiler", variable = true, export = true}, ["current-module"] = {module = "compiler", global = true, export = true}}}, lib = {import = {"core", "special"}, export = {}}, reader = {import = {"special", "core"}, export = {["read-all"] = {module = "reader", variable = true, export = true}, read = {module = "reader", variable = true, export = true}, ["define-reader"] = {module = "reader", export = true, macro = function (_g323, ...)
    local char = _g323[1]
    local stream = _g323[2]
    local body = unstash({...})
    local _g324 = sub(body, 0)
    return(join({"set", join({"get", "read-table", char}), join({"fn", join({stream})}, _g324)}))
  end}, ["read-from-string"] = {module = "reader", variable = true, export = true}, ["make-stream"] = {module = "reader", variable = true, export = true}, ["read-table"] = {module = "reader", variable = true, export = true}}}, runtime = {import = {"special", "core"}, export = {["list?"] = {module = "runtime", variable = true, export = true}, cat = {module = "runtime", variable = true, export = true}, iterate = {module = "runtime", variable = true, export = true}, ["parse-number"] = {module = "runtime", variable = true, export = true}, ["empty?"] = {module = "runtime", variable = true, export = true}, sub = {module = "runtime", variable = true, export = true}, ["composite?"] = {module = "runtime", variable = true, export = true}, inner = {module = "runtime", variable = true, export = true}, apply = {module = "runtime", variable = true, export = true}, find = {module = "runtime", variable = true, export = true}, keep = {module = "runtime", variable = true, export = true}, ["to-string"] = {module = "runtime", variable = true, export = true}, join = {module = "runtime", variable = true, export = true}, stash = {module = "runtime", variable = true, export = true}, splice = {module = "runtime", variable = true, export = true}, ["atom?"] = {module = "runtime", variable = true, export = true}, unstash = {module = "runtime", variable = true, export = true}, ["string-literal?"] = {module = "runtime", variable = true, export = true}, sublist = {module = "runtime", variable = true, export = true}, ["some?"] = {module = "runtime", variable = true, export = true}, drop = {module = "runtime", variable = true, export = true}, ["="] = {module = "runtime", variable = true, export = true}, ["<"] = {module = "runtime", variable = true, export = true}, [">"] = {module = "runtime", variable = true, export = true}, exclude = {module = "runtime", variable = true, export = true}, write = {module = "runtime", variable = true, export = true}, ["write-file"] = {module = "runtime", variable = true, export = true}, ["-"] = {module = "runtime", variable = true, export = true}, ["+"] = {module = "runtime", variable = true, export = true}, ["*"] = {module = "runtime", variable = true, export = true}, ["function?"] = {module = "runtime", variable = true, export = true}, ["keys?"] = {module = "runtime", variable = true, export = true}, ["/"] = {module = "runtime", variable = true, export = true}, ["%"] = {module = "runtime", variable = true, export = true}, print = {}, ["boolean?"] = {module = "runtime", variable = true, export = true}, exit = {module = "runtime", variable = true, export = true}, reduce = {module = "runtime", variable = true, export = true}, ["%message-handler"] = {module = "runtime", variable = true, export = true}, ["map*"] = {module = "runtime", variable = true, export = true}, mapo = {module = "runtime", variable = true, export = true}, code = {module = "runtime", variable = true, export = true}, add = {module = "runtime", variable = true, export = true}, mapt = {module = "runtime", variable = true, export = true}, split = {module = "runtime", variable = true, export = true}, hd = {module = "runtime", variable = true, export = true}, extend = {module = "runtime", variable = true, export = true}, ["string?"] = {module = "runtime", variable = true, export = true}, char = {module = "runtime", variable = true, export = true}, tl = {module = "runtime", variable = true, export = true}, ["nil?"] = {module = "runtime", variable = true, export = true}, ["read-file"] = {module = "runtime", variable = true, export = true}, [">="] = {module = "runtime", variable = true, export = true}, type = {}, ["<="] = {module = "runtime", variable = true, export = true}, reverse = {module = "runtime", variable = true, export = true}, search = {module = "runtime", variable = true, export = true}, ["is?"] = {module = "runtime", variable = true, export = true}, map = {module = "runtime", variable = true, export = true}, ["id-literal?"] = {module = "runtime", variable = true, export = true}, ["table?"] = {module = "runtime", variable = true, export = true}, substring = {module = "runtime", variable = true, export = true}, length = {module = "runtime", variable = true, export = true}, replicate = {module = "runtime", variable = true, export = true}, ["number?"] = {module = "runtime", variable = true, export = true}, last = {module = "runtime", variable = true, export = true}, pairwise = {module = "runtime", variable = true, export = true}}}, utilities = {import = {"special", "core"}, export = {["variable?"] = {module = "utilities", variable = true, export = true}, indentation = {module = "utilities", variable = true, export = true}, getenv = {module = "utilities", variable = true, export = true}, imported = {module = "utilities", variable = true, export = true}, ["with-indent"] = {module = "utilities", export = true, macro = function (form)
    local result = make_id()
    return(join({"do", join({"inc", "indent-level"}), join({"let", join({result, form}), join({"dec", "indent-level"}), result})}))
  end}, ["quote-modules"] = {module = "utilities", variable = true, export = true}, ["special-form?"] = {module = "utilities", variable = true, export = true}, ["to-id"] = {module = "utilities", variable = true, export = true}, ["bind*"] = {module = "utilities", variable = true, export = true}, ["bound?"] = {module = "utilities", variable = true, export = true}, nexus = {module = "utilities", global = true, export = true}, ["valid-id?"] = {module = "utilities", variable = true, export = true}, ["macro?"] = {module = "utilities", variable = true, export = true}, ["symbol-expansion"] = {module = "utilities", variable = true, export = true}, quasiexpand = {module = "utilities", variable = true, export = true}, quoted = {module = "utilities", variable = true, export = true}, ["quote-environment"] = {module = "utilities", variable = true, export = true}, ["make-id"] = {}, ["stash*"] = {module = "utilities", variable = true, export = true}, setenv = {module = "utilities", variable = true, export = true}, ["special?"] = {module = "utilities", variable = true, export = true}, bind = {module = "utilities", variable = true, export = true}, ["symbol?"] = {module = "utilities", variable = true, export = true}, ["macro-function"] = {module = "utilities", variable = true, export = true}, ["module-key"] = {module = "utilities", variable = true, export = true}, exported = {module = "utilities", variable = true, export = true}, ["indent-level"] = {module = "utilities", global = true, export = true}, macroexpand = {module = "utilities", variable = true, export = true}, ["initial-environment"] = {module = "utilities", variable = true, export = true}}}}
