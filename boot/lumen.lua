...
(function ()
  ...
  local reserved = {["case"] = true, ["="] = true, ["delete"] = true, ["while"] = true, ["not"] = true, ["try"] = true, ["local"] = true, ["<="] = true, ["+"] = true, ["return"] = true, ["debugger"] = true, ["until"] = true, ["/"] = true, ["void"] = true, ["-"] = true, ["throw"] = true, ["%"] = true, ["else"] = true, [">"] = true, ["this"] = true, ["<"] = true, ["if"] = true, ["false"] = true, ["finally"] = true, ["then"] = true, ["catch"] = true, ["nil"] = true, ["elseif"] = true, ["default"] = true, ["=="] = true, ["repeat"] = true, ["true"] = true, ["in"] = true, ["or"] = true, ["*"] = true, ["end"] = true, ["and"] = true, ["var"] = true, ["instanceof"] = true, ["with"] = true, ["continue"] = true, ["typeof"] = true, ["do"] = true, ["break"] = true, ["new"] = true, [">="] = true, ["switch"] = true, ["function"] = true, ["for"] = true}
...
(function ()
  ...
  local infix = {lua = {["="] = "==", cat = "..", ["~="] = true, ["and"] = true, ["or"] = true, ["not"] = true}, common = {["%"] = true, [">="] = true, ["-"] = true, ["<"] = true, ["+"] = true, ["*"] = true, ["<="] = true, ["/"] = true, [">"] = true}, js = {["="] = "===", ["not"] = "!", ["~="] = "!=", ["and"] = "&&", ["or"] = "||", cat = "+"}}
...
(function ()
  ...
  modules = {optimizer = {import = {"runtime", "special", "core"}, export = {optimizations = {variable = true}, optimize = {variable = true, export = true}, ["define-optimization"] = {}}}, reader = {import = {"runtime", "special", "core"}, export = {["read-from-string"] = {variable = true, export = true}, ["skip-non-code"] = {variable = true}, ["read-all"] = {variable = true, export = true}, ["make-stream"] = {variable = true, export = true}, ["peek-char"] = {variable = true}, ["flag?"] = {variable = true}, read = {variable = true, export = true}, eof = {variable = true}, whitespace = {variable = true}, ["key?"] = {variable = true}, ["read-table"] = {variable = true, export = true}, ["define-reader"] = {macro = function (_g599, ...)
    local char = _g599[1]
    local stream = _g599[2]
    local body = unstash({...})
    local _g600 = sub(body, 0)
    return({"set", {"get", "read-table", char}, join({"fn", {stream}}, _g600)})
  end, export = true}, ["read-char"] = {variable = true}, delimiters = {variable = true}}}, system = {import = {"special", "core"}, export = {nexus = {global = true, export = true}}}, runtime = {import = {"special", "core"}, export = {inner = {variable = true, export = true}, ["empty?"] = {variable = true, export = true}, ["module-key"] = {variable = true, export = true}, cat = {variable = true, export = true}, ["boolean?"] = {variable = true, export = true}, setenv = {variable = true, export = true}, [">="] = {variable = true, export = true}, ["id-literal?"] = {variable = true, export = true}, replicate = {variable = true, export = true}, ["nil?"] = {variable = true, export = true}, exit = {variable = true, export = true}, ["<="] = {variable = true, export = true}, ["%"] = {variable = true, export = true}, pairwise = {variable = true, export = true}, module = {variable = true, export = true}, search = {variable = true, export = true}, ["id-count"] = {variable = true}, substring = {variable = true, export = true}, ["number?"] = {variable = true, export = true}, tl = {variable = true, export = true}, reverse = {variable = true, export = true}, ["none?"] = {variable = true, export = true}, mapl = {variable = true}, drop = {variable = true, export = true}, ["keys?"] = {variable = true, export = true}, last = {variable = true, export = true}, split = {variable = true, export = true}, ["<"] = {variable = true, export = true}, stash = {variable = true, export = true}, [">"] = {variable = true, export = true}, map = {variable = true, export = true}, iterate = {variable = true, export = true}, ["read-file"] = {variable = true, export = true}, join = {variable = true, export = true}, ["-"] = {variable = true, export = true}, ["+"] = {variable = true, export = true}, ["*"] = {variable = true, export = true}, ["splice?"] = {variable = true}, ["/"] = {variable = true, export = true}, ["table?"] = {variable = true, export = true}, exclude = {variable = true, export = true}, keep = {variable = true, export = true}, ["%message-handler"] = {variable = true, export = true}, add = {variable = true, export = true}, ["make-id"] = {variable = true, export = true}, ["in?"] = {variable = true, export = true}, apply = {variable = true, export = true}, ["to-string"] = {variable = true, export = true}, ["parse-number"] = {variable = true, export = true}, unstash = {variable = true, export = true}, find = {variable = true, export = true}, ["function?"] = {variable = true, export = true}, write = {variable = true, export = true}, ["write-file"] = {variable = true, export = true}, reduce = {variable = true, export = true}, ["some?"] = {variable = true, export = true}, ["is?"] = {variable = true, export = true}, ["string?"] = {variable = true, export = true}, sub = {variable = true, export = true}, ["atom?"] = {variable = true, export = true}, ["="] = {variable = true, export = true}, ["string-literal?"] = {variable = true, export = true}, sublist = {variable = true, export = true}, ["list?"] = {variable = true, export = true}, extend = {variable = true, export = true}, hd = {variable = true, export = true}, char = {variable = true, export = true}, length = {variable = true, export = true}, splice = {variable = true, export = true}, ["composite?"] = {variable = true, export = true}, ["toplevel?"] = {variable = true, export = true}, code = {variable = true, export = true}}}, special = {import = {"runtime", "utilities", "special", "core", "compiler"}, export = {["while"] = {tr = true, special = function (cond, form)
  ...
  end, export = true, foo = true, stmt = true}, ["%local-function"] = {tr = true, special = function (name, args, body)
  ...
  end, export = true, foo = true}, ["do"] = {tr = true, special = function (...)
    local forms = unstash({...})
    local str = ""
    local _g604 = forms
    local _g605 = 0
    while (_g605 < length(_g604)) do
      local x = _g604[(_g605 + 1)]
    ...
    local _g674
    if (target == "js") then
      _g674 = ("throw new " .. compile({"Error", x}))
    else
      _g674 = ("error(" .. (compile(x) .. ")"))
    end
    local e = _g674
    return((indentation() .. e))
  end, export = true, foo = true, stmt = true}, ["not"] = {}, ["%if"] = {tr = true, special = function (cond, cons, alt)
    ...
    local _g612 = compile(_g676)
    return((indentation() .. (_g611 .. (" = " .. _g612))))
  end, export = true, foo = true, stmt = true}, ["%object"] = {special = function (...)
    local forms = unstash({...})
    local str = "{"
    local _g677
    if (target == "lua") then
    ...
    local _g613 = pairs
    local i = 0
    while (i < length(_g613)) do
      local _g614 = _g613[(i + 1)]
      local k = _g614[1]
      local v = _g614[2]
      if not(string63(k)) then
        error(("Illegal key: " .. to_string(k)))
      end
      local _g615 = compile(v)
      local _g678
  ...
  end, export = true, foo = true}, ["%global-function"] = {tr = true, special = function (name, args, body)
    if (target == "lua") then
    ...
    local k1 = compile(k)
    if ((target == "lua") and (char(_g617, 0) == "{")) then
      _g617 = ("(" .. (_g617 .. ")"))
    end
    if (string_literal63(k) and valid_id63(inner(k))) then
      return((_g617 .. ("." .. inner(k))))
    else
      return((_g617 .. ("[" .. (k1 .. "]"))))
    end
    ...
    if nil63(x) then
      ...
      _g682 = ("return(" .. (compile(x) .. ")"))
    end
    local _g618 = _g682
    return((indentation() .. _g618))
  end, export = true, foo = true, stmt = true}, ["break"] = {special = function ()
    return((indentation() .. "break"))
  end, export = true, foo = true, stmt = true}, ["%try"] = {tr = true, special = function (form)
    local ind = indentation()
    indent_level = (indent_level + 1)
    local _g619 = compile(form, {_stash = true, stmt = true})
    indent_level = (indent_level - 1)
    local body = _g619
    local e = make_id()
    local hf = {"return", {"%array", false, {"get", e, "\"message\""}}}
    indent_level = (indent_level + 1)
    local _g620 = compile(hf, {_stash = true, stmt = true})
    indent_level = (indent_level - 1)
    local h = _g620
    return((ind .. ("try {\n" .. (body .. (ind .. ("}\n" .. (ind .. ("catch (" .. (e .. (") {\n" .. (h .. (ind .. "}\n"))))))))))))
  end, export = true, foo = true, stmt = true}, ["%for"] = {tr = true, special = function (t, k, form)
    local _g621 = compile(t)
    local ind = indentation()
    indent_level = (indent_level + 1)
    local _g622 = compile(form, {_stash = true, stmt = true})
    indent_level = (indent_level - 1)
    local body = _g622
    if (target == "lua") then
      return((ind .. ("for " .. (k .. (" in next, " .. (_g621 .. (" do\n" .. (body .. (ind .. "end\n")))))))))
    else
      return((ind .. ("for (" .. (k .. (" in " .. (_g621 .. (") {\n" .. (body .. (ind .. "}\n")))))))))
    end
  end, export = true, foo = true, stmt = true}}}, main = {import = {"runtime", "special", "core", "reader", "compiler"}, export = {save = {macro = function (...)
    local specs = unstash({...})
    local _g623 = sub(specs, 0)
    map(compile_module, _g623)
    return(nil)
  end}}}, lib = {import = {"core", "special"}, export = {}}, core = {import = {"runtime", "utilities", "special", "core", "compiler"}, export = {["let-macro"] = {macro = function (definitions, ...)
    local body = unstash({...})
    ...
    local l = {}
    local _g626 = elements
    local _g627 = 0
    while (_g627 < length(_g626)) do
      local e = _g626[(_g627 + 1)]
      l[e] = true
      _g627 = (_g627 + 1)
    end
    return(join({"table"}, l))
  ...
  end, export = true, global = true}, ["with-frame"] = {macro = function (...)
    local body = unstash({...})
    ...
    local _g639 = {"table"}
    _g639._scope = scope
    return({"do", {"add", "environment", _g639}, {"let", {x, join({"do"}, _g638)}, {"drop", "environment"}, x}})
    ...
    if nil63(v) then
      ...
      local i = _g684
      _g683 = {"let", {i, 0}, {"while", {"<", i, {"length", t1}}, join({"let", {k, {"at", t1, i}}}, _g640), {"inc", i}}}
    else
      local _g641 = {"target"}
      _g641.js = {"isNaN", {"parseInt", k}}
      _g641.lua = {"not", {"number?", k}}
      _g683 = {"let", {k, "nil"}, {"%for", t1, k, {"when", _g641, join({"let", {v, {"get", t1, k}}}, _g640)}}}
    end
    return({"let", {t1, t}, _g683})
  end, export = true}, ["with-bindings"] = {macro = function (_g642, ...)
    local names = _g642[1]
    local body = unstash({...})
    local _g643 = sub(body, 0)
    local x = make_id()
    local _g645 = {"setenv", x}
    _g645.variable = true
    local _g644 = {"with-frame", {"each", {x}, names, _g645}}
    _g644.scope = true
    ...
    local _g647 = join({"do"}, macroexpand(_g646))
    drop(environment)
    return(_g647)
    ...
    local _g650 = {"setenv", {"quote", name}}
    _g650.macro = form
    _g650.form = {"quote", form}
    eval(_g650)
    return(nil)
    ...
    local imports = {}
    local imp = _g651.import
    local exp = _g651.export
    local _g652 = (imp or {})
    local _g653 = 0
    while (_g653 < length(_g652)) do
      local k = _g652[(_g653 + 1)]
      load_module(k)
    ...
    local _g654 = (exp or {})
    local _g655 = 0
    while (_g655 < length(_g654)) do
      local k = _g654[(_g655 + 1)]
    ...
    local form = join({"fn", args}, _g659)
    local keys = sub(_g659, length(_g659))
    local _g660 = {"setenv", {"quote", name}}
    _g660.special = form
    _g660.form = {"quote", form}
    eval(join(_g660, keys))
    return(nil)
    ...
    if some63(_g662) then
      ...
      local args = _g663[1]
      local _g664 = _g663[2]
      return(join({"%local-function", name, args}, _g664))
    else
      return({"%local", name, x})
    end
    ...
    map(function (_g666)
      local lh = _g666[1]
      local rh = _g666[2]
      local _g667 = bind(lh, rh)
      local _g668 = 0
      while (_g668 < length(_g667)) do
        local _g669 = _g667[(_g668 + 1)]
        local id = _g669[1]
        local val = _g669[2]
  ...
  end}, modules = {global = true, export = true}}}, utilities = {import = {"runtime", "special", "core"}, export = {["symbol?"] = {variable = true, export = true}, ["to-id"] = {variable = true, export = true}, ["can-unquote?"] = {variable = true}, getenv = {variable = true, export = true}, ["quasiquoting?"] = {variable = true}, ["valid-id?"] = {variable = true, export = true}, ["global?"] = {variable = true}, ["bind*"] = {variable = true, export = true}, exported = {variable = true, export = true}, macroexpand = {variable = true, export = true}, ["statement?"] = {variable = true, export = true}, ["quasisplice?"] = {variable = true}, ["indent-level"] = {global = true, export = true}, ["symbol-expansion"] = {variable = true, export = true}, ["reserved?"] = {variable = true, export = true}, indentation = {variable = true, export = true}, ["quote-frame"] = {variable = true}, ["quote-environment"] = {variable = true, export = true}, quoted = {variable = true, export = true}, quasiexpand = {variable = true, export = true}, ["quote-module"] = {variable = true}, ["quote-binding"] = {variable = true}, ["valid-char?"] = {variable = true}, ["macro-function"] = {variable = true, export = true}, ["with-indent"] = {macro = function (form)
    local result = make_id()
    return({"do", {"inc", "indent-level"}, {"let", {result, form}, {"dec", "indent-level"}, result}})
  end, export = true}, ["bound?"] = {variable = true, export = true}, ["special-form?"] = {variable = true, export = true}, imported = {variable = true, export = true}, ["numeric?"] = {variable = true}, reserved = {variable = true}, ["stash*"] = {variable = true, export = true}, ["quasiquote-list"] = {variable = true}, ["quoting?"] = {variable = true}, ["macro?"] = {variable = true, export = true}, ["variable?"] = {variable = true, export = true}, mapo = {variable = true, export = true}, ["special?"] = {variable = true, export = true}, ["initial-environment"] = {variable = true, export = true}, ["quote-modules"] = {variable = true, export = true}, bind = {variable = true, export = true}, ["toplevel?"] = {variable = true, export = true}, escape = {variable = true}}}, compiler = {import = {"runtime", "utilities", "special", "core", "reader"}, export = {["lower-if"] = {variable = true}, ["lower-statement"] = {variable = true}, process = {variable = true}, ["lower-infix"] = {variable = true}, ["lower-special"] = {variable = true}, ["compile-args"] = {variable = true}, ["infix?"] = {variable = true}, ["unary?"] = {variable = true}, ["lower-call"] = {variable = true}, ["in-module"] = {variable = true, export = true}, eval = {variable = true, export = true}, ["compile-module"] = {variable = true, export = true}, ["compiler-output"] = {variable = true}, getop = {variable = true}, encapsulate = {variable = true}, ["%compile-module"] = {variable = true}, ["lower-do"] = {variable = true}, ["compile-call"] = {variable = true}, ["can-return?"] = {variable = true}, ["lower-body"] = {variable = true}, ["open-module"] = {variable = true, export = true}, ["lower-function"] = {variable = true}, ["lower-definition"] = {variable = true}, terminator = {variable = true}, infix = {variable = true}, ["lower-try"] = {variable = true}, lower = {variable = true, export = true, global = true}, ["%result"] = {global = true, export = true}, ["compile-file"] = {variable = true}, prologue = {variable = true}, ["lower-infix?"] = {variable = true}, ["lower-short"] = {variable = true}, ["compiling?"] = {variable = true}, compile = {variable = true, export = true}, run = {variable = true}, ["module-path"] = {variable = true}, ["current-module"] = {global = true, export = true}, ["load-module"] = {variable = true, export = true}, ["compile-special"] = {variable = true}, ["compile-function"] = {variable = true, export = true}, ["compile-atom"] = {variable = true}, ["lower-while"] = {variable = true}, ["lower-for"] = {variable = true}, ["compile-infix"] = {variable = true}}}}
