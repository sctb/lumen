...
function macroexpand(form)
  ...
  elseif atom63(form) then
    ...
    elseif (x == "%function") then
      local _g2 = form[1]
      local args = form[2]
      local _g61 = sub(form, 2)
      add(environment, {})
      local _g63 = (function ()
        local _g65 = 0
        local _g64 = args
        while (_g65 < length(_g64)) do
          local _g62 = _g64[(_g65 + 1)]
...
function sub(x, from, upto)
  local _g75 = (from or 0)
  if string63(x) then
    return((string.sub)(x, (_g75 + 1), upto))
  else
    local l = (function ()
      local i = _g75
      local j = 0
...
function join(l1, l2)
  ...
  elseif nil63(l2) then
    ...
    local _g79 = nil
    local _g78 = l2
    for _g79 in next, _g78 do
      if (not number63(_g79)) then
        local v = _g78[_g79]
        l[_g79] = v
      end
    end
...
function apply(f, args)
  local _g107 = stash(args)
  return(f(unpack(_g107)))
end
id_count = 0
function make_id()
  id_count = (id_count + 1)
...
function compile_branch(condition, body, first63, last63, tail63)
  ...
  local _g117 = (function ()
    ...
    local _g118 = compile(body, {_stash = true, ["stmt?"] = true, ["tail?"] = tail63})
    indent_level = (indent_level - 1)
    return(_g118)
  end)()
...
function compile(form, ...)
  local _g165 = unstash({...})
  local stmt63 = _g165["stmt?"]
  local tail63 = _g165["tail?"]
...
function save_environment()
  ...
  local k = nil
  local _g169 = map42(quote_binding, toplevel)
...
function rep(str)
  local _g171 = (function ()
    local _g172,_g173 = xpcall(function ()
...
setenv("%function", {special = function (_g178)
  local args = _g178[1]
  local body = sub(_g178, 1)
...
setenv("define-global", {macro = function (name, x, ...)
  ...
  if (not empty63(_g179)) then
    local _g180 = bind_arguments(x, _g179)
    local args = _g180[1]
    local _g181 = _g180[2]
    return(join({"%global-function", name, args}, _g181))
  else
    return({"set", name, x})
  end
end})
...
setenv("define-special", {macro = function (name, args, ...)
  ...
  local form = join({"fn", args}, _g183)
  local value = join((function ()
    local _g184 = {"table"}
    _g184.special = form
    _g184.form = {"quote", form}
    return(_g184)
  end)(), _g183)
...
setenv("define", {macro = function (name, x, ...)
  ...
  return(join({"define-global", name, x}, _g187))
end})
setenv("list*", {macro = function (...)
  local xs = unstash({...})
  if empty63(xs) then
...
setenv("%for", {tr = true, stmt = true, special = function (_g189)
  local _g190 = _g189[1]
  local t = _g190[1]
  local k = _g190[2]
...
setenv("each", {macro = function (_g192, ...)
  local t = _g192[1]
  local k = _g192[2]
  local v = _g192[3]
  local body = unstash({...})
  ...
  return({"let", {k, "nil", t1, t}, {"%for", {t1, k}, {"if", (function ()
    local _g194 = {"target"}
    _g194.js = {"isNaN", {"parseInt", k}}
    _g194.lua = {"not", {"number?", k}}
    return(_g194)
  end)(), join({"let", {v, {"get", t1, k}}}, _g193)}}})
end})
setenv("define-reader", {macro = function (_g195, ...)
  local char = _g195[1]
...
setenv("set", {stmt = true, special = function (_g197)
  local lh = _g197[1]
  local rh = _g197[2]
  if nil63(rh) then
...
setenv("across", {macro = function (_g198, ...)
  local l = _g198[1]
  local v = _g198[2]
  local i = _g198[3]
  local start = _g198[4]
...
setenv("break", {stmt = true, special = function (_g111)
...
setenv("while", {tr = true, stmt = true, special = function (_g208)
...
setenv("error", {stmt = true, special = function (_g211)
  local x = _g211[1]
  local e = (function ()
    if (target == "js") then
...
setenv("%try", {tr = true, stmt = true, special = function (forms)
  local ind = indentation()
  local body = (function ()
    indent_level = (indent_level + 1)
    local _g212 = compile_body(forms, {_stash = true, ["tail?"] = true})
    indent_level = (indent_level - 1)
    return(_g212)
  end)()
  local e = make_id()
  ...
  local h = (function ()
    indent_level = (indent_level + 1)
    local _g213 = compile(handler, {_stash = true, ["stmt?"] = true})
    indent_level = (indent_level - 1)
    return(_g213)
  end)()
  return((ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n"))
end})
setenv("return", {stmt = true, special = function (_g214)
  local x = _g214[1]
  return((indentation() .. compile_call({"return", x})))
end})
setenv("if", {tr = true, stmt = true, special = function (form, tail63)
  local str = ""
  local i = 0
  local _g215 = form
...
setenv("%local-function", {tr = true, stmt = true, special = function (_g227)
  local name = _g227[1]
  local args = _g227[2]
  local body = sub(_g227, 2)
  return(compile_function(args, body, {_stash = true, name = name, prefix = "local "}))
end})
setenv("%local", {stmt = true, special = function (_g228)
  local name = _g228[1]
  local value = _g228[2]
...
setenv("%global-function", {tr = true, stmt = true, special = function (_g229)
  local name = _g229[1]
  local args = _g229[2]
  local body = sub(_g229, 2)
  if (target == "lua") then
...
setenv("do", {tr = true, stmt = true, special = function (forms, tail63)
  return(compile_body(forms, {_stash = true, ["tail?"] = tail63}))
end})
setenv("with-bindings", {macro = function (_g230, ...)
  local names = _g230[1]
  local body = unstash({...})
...
setenv("define-local", {macro = function (name, x, ...)
  ...
  if (not empty63(_g235)) then
    local _g236 = bind_arguments(x, _g235)
    local args = _g236[1]
    local _g237 = _g236[2]
    return(join({"%local-function", name, args}, _g237))
  else
    return({"%local", name, x})
  end
end})
