...
compile_branch = function (condition, body, first63, last63, tail63)
  ...
  local _g98 = (function ()
    ...
    local _g99 = compile(body, {_stash = true, ["stmt?"] = true, ["tail?"] = tail63})
    indent_level = (indent_level - 1)
    return(_g99)
  end)()
...
compile_function = function (args, body, name)
  local _g100 = (name or "")
  local _g101 = compile_args(args)
  local _g102 = (function ()
    indent_level = (indent_level + 1)
    local _g103 = compile_body(body, {_stash = true, ["tail?"] = true})
    indent_level = (indent_level - 1)
    return(_g103)
  end)()
  local ind = indentation()
...
special["while"] = {compiler = function (form)
  ...
  local body = (function ()
    indent_level = (indent_level + 1)
    local _g109 = compile_body(tl(form))
    indent_level = (indent_level - 1)
    return(_g109)
  end)()
  local ind = indentation()
...
special["for"] = {compiler = function (_g110)
  local _g111 = _g110[1]
  local t = _g111[1]
  local k = _g111[2]
  local body = sub(_g110, 1)
  local t = compile(t)
  local ind = indentation()
  local body = (function ()
    indent_level = (indent_level + 1)
    local _g112 = compile_body(body)
    indent_level = (indent_level - 1)
    return(_g112)
  end)()
  if (target == "lua") then
...
special["try"] = {compiler = function (forms)
  ...
  local body = (function ()
    indent_level = (indent_level + 1)
    local _g113 = compile_body(forms, {_stash = true, ["tail?"] = true})
    indent_level = (indent_level - 1)
    return(_g113)
  end)()
  local e = make_id()
  ...
  local h = (function ()
    indent_level = (indent_level + 1)
    local _g114 = compile(handler, {_stash = true, ["stmt?"] = true})
    indent_level = (indent_level - 1)
    return(_g114)
  end)()
  return((ind .. "try {\n" .. body .. ind .. "}\n" .. ind .. "catch (" .. e .. ") {\n" .. h .. ind .. "}\n"))
...
special["break"] = {compiler = function (_g115)
  return((indentation() .. "break"))
end, stmt = true}

special["function"] = {compiler = function (_g116)
  local args = _g116[1]
  local body = sub(_g116, 1)
  return(compile_function(args, body))
end}

macros = ""

special["define-macro"] = {compiler = function (_g117)
  local name = _g117[1]
  local args = _g117[2]
  local body = sub(_g117, 2)
...
special["return"] = {compiler = function (_g118)
  local x = _g118[1]
  return((indentation() .. compile_call({"return", x})))
end, stmt = true}

special["error"] = {compiler = function (_g119)
  local x = _g119[1]
  local e = (function ()
    if (target == "js") then
...
special["local"] = {compiler = function (_g120)
  local name = _g120[1]
  local value = _g120[2]
...
special["set"] = {compiler = function (_g121)
  local lh = _g121[1]
  local rh = _g121[2]
  if nil63(rh) then
...
special["get"] = {compiler = function (_g122)
  local t = _g122[1]
  local k = _g122[2]
  local t = compile(t)
  local k1 = compile(k)
...
special["not"] = {compiler = function (_g123)
  local x = _g123[1]
  local x = compile(x)
  local open = (function ()
    if (target == "js") then
...
compile_toplevel = function (form)
  local _g130 = compile(macroexpand(form), {_stash = true, ["stmt?"] = true})
  if (_g130 == "") then
    return("")
  else
    return((_g130 .. "\n"))
...
setenv("define-special", function (name, args, ...)
  local body = unstash({...})
  local _g106 = sub(body, 0)
  return({"set", {"get", "special", {"quote", name}}, join((function ()
    local _g107 = {"table"}
    _g107.compiler = join({"fn", args}, _g106)
    return(_g107)
  end)(), _g106)})
end)
