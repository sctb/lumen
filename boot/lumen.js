...
infix = {lua: {"cat": "..", "or": true, "=": "==", "~=": true, "and": true}, common: {">": true, "-": true, "/": true, "*": true, "<": true, "+": true, ">=": true, "%": true, "<=": true}, js: {"cat": "+", "=": "===", "or": "||", "~=": "!=", "and": "&&"}};
...
special["define-macro"] = {tr: true, compiler: function (_g120) {
  var name = _g120[0];
  var args = _g120[1];
