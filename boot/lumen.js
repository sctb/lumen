...
infix = {common: {"<=": true, ">": true, "/": true, "%": true, "+": true, "<": true, "-": true, "*": true, ">=": true}, js: {"or": "||", "cat": "+", "=": "===", "and": "&&", "~=": "!="}, lua: {"or": true, "cat": "..", "=": "==", "and": true, "~=": true}};
...
special["%for"] = {stmt: true, compiler: function (_g113) {
  var _g114 = _g113[0];
  var t = _g114[0];
  var k = _g114[1];
