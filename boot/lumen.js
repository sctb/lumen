...
infix = {lua: {"and": true, "=": "==", "~=": true, "cat": "..", "or": true}, common: {"-": true, "<": true, "/": true, ">": true, "%": true, "*": true, ">=": true, "+": true, "<=": true}, js: {"or": "||", "and": "&&", "~=": "!=", "=": "===", "cat": "+"}};
getop = function (op) {
...
compile_body = function (forms) {
  var _g91 = unstash(sub(arguments, 1));
  var tail63 = _g91["tail?"];
  var str = "";
  var i = 0;
  var _g92 = forms;
  while ((i < length(_g92))) {
...
compile_branch = function (condition, body, first63, last63, tail63) {
  ...
  var _g95 = (function () {
    ...
    var _g96 = compile(body, {_stash: true, "stmt?": true, "tail?": tail63});
    indent_level = (indent_level - 1);
    return(_g96);
  })();
  var ind = indentation();
...
compile_function = function (args, body, name) {
  var _g97 = (name || "");
  var _g98 = compile_args(args);
  var _g99 = (function () {
    indent_level = (indent_level + 1);
    var _g100 = compile_body(body, {_stash: true, "tail?": true});
    indent_level = (indent_level - 1);
    return(_g100);
  })();
  var ind = indentation();
...
compile_special = function (form, stmt63, tail63) {
  var _g101 = getenv(hd(form));
  var stmt = _g101.stmt;
  var self_tr63 = _g101.tr;
  var special = _g101.special;
  if ((!(stmt63) && stmt)) {
...
compile = function (form) {
  var _g136 = unstash(sub(arguments, 1));
  var stmt63 = _g136["stmt?"];
  var tail63 = _g136["tail?"];
...
save_environment = function () {
  ...
  var k = undefined;
  var _g140 = map42(quote_binding, toplevel);
  for (k in _g140) {
    if (isNaN(parseInt(k))) {
      var v = _g140[k];
...
environment = [{}];
setenv("define-reader", {macro: function (_g149) {
  var char = _g149[0];
  var stream = _g149[1];
  var body = unstash(sub(arguments, 1));
  var _g150 = sub(body, 0);
  return(["set", ["get", "read-table", char], join(["fn", [stream]], _g150)]);
}});
...
setenv("%try", {tr: true, stmt: true, special: function (forms) {
  ...
  var body = (function () {
    indent_level = (indent_level + 1);
    var _g155 = compile_body(forms, {_stash: true, "tail?": true});
    indent_level = (indent_level - 1);
    return(_g155);
  })();
  var e = make_id();
  ...
  var h = (function () {
    indent_level = (indent_level + 1);
    var _g156 = compile(handler, {_stash: true, "stmt?": true});
    indent_level = (indent_level - 1);
    return(_g156);
  })();
  return((ind + "try {\n" + body + ind + "}\n" + ind + "catch (" + e + ") {\n" + h + ind + "}\n"));
...
setenv("%local", {special: function (_g157) {
  var name = _g157[0];
  var value = _g157[1];
  var id = compile(name);
...
setenv("error", {special: function (_g158) {
  var x = _g158[0];
  var e = (function () {
    if ((target === "js")) {
...
setenv("%for", {tr: true, stmt: true, special: function (_g159) {
  var _g160 = _g159[0];
  var t = _g160[0];
  var k = _g160[1];
...
setenv("let-macro", {macro: function (definitions) {
  ...
  var _g164 = (function () {
    ...
    return(join(["do"], macroexpand(_g163)));
  })();
  drop(environment);
  return(_g164);
}});
...
setenv("set", {special: function (_g165) {
  var lh = _g165[0];
  var rh = _g165[1];
  if (nil63(rh)) {
...
setenv("fn", {macro: function (args) {
  ...
  var _g167 = bind_arguments(args, _g166);
  var args = _g167[0];
  var _g168 = _g167[1];
  return(join(["%function", args], _g168));
}});
setenv("return", {special: function (_g169) {
  var x = _g169[0];
...
setenv("let-symbol", {macro: function (expansions) {
  ...
  var _g173 = (function () {
    ...
    return(join(["do"], macroexpand(_g172)));
  })();
  drop(environment);
  return(_g173);
}});
...
setenv("define-macro", {macro: function (name, args) {
  ...
  var form = join(["fn", args], _g177);
  var value = (function () {
    var _g178 = ["table"];
    _g178.macro = form;
    _g178.form = ["quote", form];
    return(_g178);
  })();
  var binding = ["setenv", ["quote", name], value];
  eval(binding);
...
setenv("each", {macro: function (_g179) {
  var t = _g179[0];
  var k = _g179[1];
  var v = _g179[2];
  var body = unstash(sub(arguments, 1));
  ...
  return(["let", [k, "nil", t1, t], ["%for", [t1, k], ["if", (function () {
    var _g181 = ["target"];
    _g181.lua = ["not", ["number?", k]];
    _g181.js = ["isNaN", ["parseInt", k]];
    return(_g181);
  })(), join(["let", [v, ["get", t1, k]]], _g180)]]]);
}});
...
setenv("cat!", {macro: function (a) {
  ...
  var _g183 = sub(bs, 0);
  return(["set", a, join(["cat", a], _g183)]);
}});
setenv("not", {special: function (_g184) {
  var x = _g184[0];
  var x = compile(x);
  var open = (function () {
    if ((target === "js")) {
...
setenv("let", {macro: function (bindings) {
  ...
  map(function (_g190) {
    ...
    var rh = _g190[1];
    var _g192 = 0;
    var _g191 = bind(lh, rh);
    while ((_g192 < length(_g191))) {
      var _g193 = _g191[_g192];
      var id = _g193[0];
      var val = _g193[1];
      if (bound63(id)) {
        var rename = make_id();
  ...
  return(join(["do"], join(locals, [join(["let-symbol", renames], _g189)])));
}});
...
setenv("while", {tr: true, stmt: true, special: function (_g197) {
  var condition = _g197[0];
  var body = sub(_g197, 1);
  var condition = compile(condition);
  var body = (function () {
    indent_level = (indent_level + 1);
    var _g198 = compile_body(body);
    indent_level = (indent_level - 1);
    return(_g198);
  })();
  var ind = indentation();
