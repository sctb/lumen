...
infix = {js: {"and": "&&", "or": "||", "~=": "!=", "=": "===", "cat": "+"}, common: {"/": true, ">": true, "-": true, "<": true, "<=": true, "*": true, ">=": true, "+": true, "%": true}, lua: {"and": true, "or": true, "~=": true, "=": "==", "cat": ".."}};
getop = function (op) {
...
setenv("set", {special: function (_g177) {
  var lh = _g177[0];
  var rh = _g177[1];
  if (nil63(rh)) {
...
setenv("fn", {macro: function (args) {
  ...
  var _g180 = bind_arguments(args, _g179);
  var args = _g180[0];
  var _g181 = _g180[1];
...
setenv("define", {macro: function (name, x) {
  ...
  return(join(["define-global", name, x], _g182));
}});
setenv("define-macro", {macro: function (name, args) {
  var body = unstash(sub(arguments, 2));
  var _g183 = sub(body, 0);
  var form = join(["fn", args], _g183);
  var value = (function () {
    var _g184 = ["table"];
    _g184.macro = form;
...
setenv("let", {macro: function (bindings) {
  ...
  map(function (_g186) {
    ...
    var rh = _g186[1];
    var _g188 = 0;
    var _g187 = bind(lh, rh);
    while ((_g188 < length(_g187))) {
      var _g189 = _g187[_g188];
      var id = _g189[0];
      var val = _g189[1];
      if (bound63(id)) {
        var rename = make_id();
...
setenv("%for", {tr: true, special: function (_g190) {
  var _g191 = _g190[0];
  var t = _g191[0];
  var k = _g191[1];
...
setenv("across", {macro: function (_g193) {
  var l = _g193[0];
  var v = _g193[1];
  var i = _g193[2];
  var start = _g193[3];
  ...
  i = (i || make_id());
  start = (start || 0);
  return(["let", [i, start, l1, l], ["while", ["<", i, ["length", l1]], join(["let", [v, ["at", l1, i]]], join(_g194, [["inc", i]]))]]);
}});
...
setenv("%function", {special: function (_g197) {
  var args = _g197[0];
...
setenv("not", {special: function (_g206) {
  var x = _g206[0];
  var x = compile(x);
  var open = (function () {
    if ((target === "js")) {
...
setenv("%global-function", {tr: true, special: function (_g210) {
  var name = _g210[0];
  var args = _g210[1];
...
setenv("while", {tr: true, special: function (_g212) {
...
setenv("%local", {special: function (_g220) {
  var name = _g220[0];
  var value = _g220[1];
  var id = compile(name);
...
setenv("%local-function", {tr: true, special: function (_g222) {
  var name = _g222[0];
  var args = _g222[1];
  var body = sub(_g222, 2);
...
setenv("define-reader", {macro: function (_g227) {
  var char = _g227[0];
  var stream = _g227[1];
  var body = unstash(sub(arguments, 1));
...
setenv("%try", {tr: true, special: function (forms) {
  ...
  var body = (function () {
    indent_level = (indent_level + 1);
    var _g229 = compile_body(forms, {_stash: true, "tail?": true});
    indent_level = (indent_level - 1);
    return(_g229);
  })();
  var e = make_id();
  ...
  var h = (function () {
    indent_level = (indent_level + 1);
    var _g230 = compile(handler, {_stash: true, "stmt?": true});
    indent_level = (indent_level - 1);
    return(_g230);
  })();
  return((ind + "try {\n" + body + ind + "}\n" + ind + "catch (" + e + ") {\n" + h + ind + "}\n"));
...
setenv("let-macro", {macro: function (definitions) {
  ...
  var _g232 = (function () {
    ...
    return(join(["do"], macroexpand(_g231)));
  })();
  drop(environment);
  return(_g232);
}});
...
setenv("with-bindings", {macro: function (_g233) {
  var names = _g233[0];
  var body = unstash(sub(arguments, 1));
...
setenv("error", {special: function (_g237) {
  var x = _g237[0];
  var e = (function () {
    if ((target === "js")) {
