...
infix = {lua: {"=": "==", "~=": true, "or": true, "and": true, "cat": ".."}, common: {"%": true, "*": true, "+": true, ">": true, "/": true, "<=": true, "-": true, ">=": true, "<": true}, js: {"=": "===", "~=": "!=", "or": "||", "and": "&&", "cat": "+"}};
...
special["for"] = {tr: true, compiler: function (_72) {
  var _73 = _72[0];
  var t = _73[0];
  var k = _73[1];
  var body = sub(_72, 1);
...
special["define-macro"] = {tr: true, compiler: function (_77) {
  var name = _77[0];
  var args = _77[1];
  var body = sub(_77, 2);
